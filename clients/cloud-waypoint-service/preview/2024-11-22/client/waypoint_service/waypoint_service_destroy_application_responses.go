...
func (o *WaypointServiceDestroyApplicationOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/applications/{application.id}][%d] waypointServiceDestroyApplicationOK %s", 200, payload)
}
...
func (o *WaypointServiceDestroyApplicationOK) GetPayload() models.HashicorpCloudWaypointV20241122DestroyApplicationResponse {
	return o.Payload
}
...
func (o *WaypointServiceDestroyApplicationDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/applications/{application.id}][%d] WaypointService_DestroyApplication default %s", o._statusCode, payload)
}
