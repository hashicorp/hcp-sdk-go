...
func (o *WaypointServiceUpdateAddOnDefinition2OK) Error() string {
	...
	return fmt.Sprintf("[PUT /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/add-on-definition/by-name/{existing_add_on_definition.name}][%d] waypointServiceUpdateAddOnDefinition2OK %s", 200, payload)
}
...
func (o *WaypointServiceUpdateAddOnDefinition2OK) GetPayload() *models.HashicorpCloudWaypointV20241122UpdateAddOnDefinitionResponse {
	return o.Payload
}
...
func (o *WaypointServiceUpdateAddOnDefinition2Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/add-on-definition/by-name/{existing_add_on_definition.name}][%d] WaypointService_UpdateAddOnDefinition2 default %s", o._statusCode, payload)
}
