...
func (o *WaypointServiceDeleteApplicationTemplate3OK) Error() string {
	...
	return fmt.Sprintf("[DELETE /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/templates/{application_template.id}][%d] waypointServiceDeleteApplicationTemplate3OK %s", 200, payload)
}
...
func (o *WaypointServiceDeleteApplicationTemplate3OK) GetPayload() models.HashicorpCloudWaypointV20241122DeleteApplicationTemplateResponse {
	return o.Payload
}
...
func (o *WaypointServiceDeleteApplicationTemplate3Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/templates/{application_template.id}][%d] WaypointService_DeleteApplicationTemplate3 default %s", o._statusCode, payload)
}
