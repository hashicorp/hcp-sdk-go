...
func (o *WaypointServiceDestroyAddOnOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/add-on/{add_on.id}][%d] waypointServiceDestroyAddOnOK %s", 200, payload)
}
...
func (o *WaypointServiceDestroyAddOnOK) GetPayload() models.HashicorpCloudWaypointV20241122DestroyAddOnResponse {
	return o.Payload
}
...
func (o *WaypointServiceDestroyAddOnDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/add-on/{add_on.id}][%d] WaypointService_DestroyAddOn default %s", o._statusCode, payload)
}
