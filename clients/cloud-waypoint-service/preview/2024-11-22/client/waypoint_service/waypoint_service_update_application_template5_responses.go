...
func (o *WaypointServiceUpdateApplicationTemplate5OK) Error() string {
	...
	return fmt.Sprintf("[PATCH /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/templates/{existing_application_template.id}][%d] waypointServiceUpdateApplicationTemplate5OK %s", 200, payload)
}
...
func (o *WaypointServiceUpdateApplicationTemplate5OK) GetPayload() *models.HashicorpCloudWaypointV20241122UpdateApplicationTemplateResponse {
	return o.Payload
}
...
func (o *WaypointServiceUpdateApplicationTemplate5Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/templates/{existing_application_template.id}][%d] WaypointService_UpdateApplicationTemplate5 default %s", o._statusCode, payload)
}
