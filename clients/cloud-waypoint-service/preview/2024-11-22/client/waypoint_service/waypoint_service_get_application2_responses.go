...
func (o *WaypointServiceGetApplication2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewWaypointServiceGetApplication2OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewWaypointServiceGetApplication2Default(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewWaypointServiceGetApplication2OK() *WaypointServiceGetApplication2OK {
	return &WaypointServiceGetApplication2OK{}
}
...
type WaypointServiceGetApplication2OK struct {
	Payload *models.HashicorpCloudWaypointV20241122GetApplicationResponse
}
...
func (o *WaypointServiceGetApplication2OK) Error() string {
	...
	return fmt.Sprintf("[GET /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/applications/by-name/{application.name}][%d] waypointServiceGetApplication2OK %s", 200, payload)
}
...
func (o *WaypointServiceGetApplication2OK) GetPayload() *models.HashicorpCloudWaypointV20241122GetApplicationResponse {
	return o.Payload
}

func (o *WaypointServiceGetApplication2OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.HashicorpCloudWaypointV20241122GetApplicationResponse)
...
func NewWaypointServiceGetApplication2Default(code int) *WaypointServiceGetApplication2Default {
	return &WaypointServiceGetApplication2Default{
		_statusCode: code,
	}
}
...
func (o *WaypointServiceGetApplication2Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/applications/by-name/{application.name}][%d] WaypointService_GetApplication2 default %s", o._statusCode, payload)
}
...
func (o *WaypointServiceGetApplication2Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
