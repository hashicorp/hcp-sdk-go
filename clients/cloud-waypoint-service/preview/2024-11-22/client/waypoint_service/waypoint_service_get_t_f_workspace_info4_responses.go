...
func (o *WaypointServiceGetTFWorkspaceInfo4Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/add-on/{add_on.id}/workspace][%d] WaypointService_GetTFWorkspaceInfo4 default %s", o._statusCode, payload)
}
