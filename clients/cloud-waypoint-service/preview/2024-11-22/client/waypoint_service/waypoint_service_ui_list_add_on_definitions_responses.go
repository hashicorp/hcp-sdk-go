...
type WaypointServiceUIListAddOnDefinitionsOK struct {
	Payload *models.HashicorpCloudWaypointV20241122UIListAddOnDefinitionsResponse
}
...
func (o *WaypointServiceUIListAddOnDefinitionsOK) Error() string {
	...
	return fmt.Sprintf("[GET /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/ui/add-on-definitions][%d] waypointServiceUiListAddOnDefinitionsOK %s", 200, payload)
}
...
func (o *WaypointServiceUIListAddOnDefinitionsOK) GetPayload() *models.HashicorpCloudWaypointV20241122UIListAddOnDefinitionsResponse {
	return o.Payload
}
...
func (o *WaypointServiceUIListAddOnDefinitionsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.HashicorpCloudWaypointV20241122UIListAddOnDefinitionsResponse)
...
func (o *WaypointServiceUIListAddOnDefinitionsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/ui/add-on-definitions][%d] WaypointService_UI_ListAddOnDefinitions default %s", o._statusCode, payload)
}
