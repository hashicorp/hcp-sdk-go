...
func (o *WaypointServiceDeleteApplicationTemplate2Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/application-templates/by-name/{application_template.name}][%d] WaypointService_DeleteApplicationTemplate2 default %s", o._statusCode, payload)
}
