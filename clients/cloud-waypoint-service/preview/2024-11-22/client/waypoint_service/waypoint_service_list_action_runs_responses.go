...
type WaypointServiceListActionRunsOK struct {
	Payload *models.HashicorpCloudWaypointV20241122ListActionRunsResponse
}
...
func (o *WaypointServiceListActionRunsOK) Error() string {
	...
	return fmt.Sprintf("[GET /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/action/{action_id}/runs][%d] waypointServiceListActionRunsOK %s", 200, payload)
}
...
func (o *WaypointServiceListActionRunsOK) GetPayload() *models.HashicorpCloudWaypointV20241122ListActionRunsResponse {
	return o.Payload
}
...
func (o *WaypointServiceListActionRunsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.HashicorpCloudWaypointV20241122ListActionRunsResponse)
...
func (o *WaypointServiceListActionRunsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/action/{action_id}/runs][%d] WaypointService_ListActionRuns default %s", o._statusCode, payload)
}
