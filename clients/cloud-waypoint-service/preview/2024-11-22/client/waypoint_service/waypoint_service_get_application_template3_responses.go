...
func (o *WaypointServiceGetApplicationTemplate3OK) Error() string {
	...
	return fmt.Sprintf("[GET /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/templates/{application_template.id}][%d] waypointServiceGetApplicationTemplate3OK %s", 200, payload)
}
...
func (o *WaypointServiceGetApplicationTemplate3OK) GetPayload() *models.HashicorpCloudWaypointV20241122GetApplicationTemplateResponse {
	return o.Payload
}
...
func (o *WaypointServiceGetApplicationTemplate3Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/templates/{application_template.id}][%d] WaypointService_GetApplicationTemplate3 default %s", o._statusCode, payload)
}
