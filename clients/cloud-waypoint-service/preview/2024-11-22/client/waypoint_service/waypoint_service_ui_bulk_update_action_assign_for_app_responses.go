...
func (o *WaypointServiceUIBulkUpdateActionAssignForAppReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewWaypointServiceUIBulkUpdateActionAssignForAppOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewWaypointServiceUIBulkUpdateActionAssignForAppDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewWaypointServiceUIBulkUpdateActionAssignForAppOK() *WaypointServiceUIBulkUpdateActionAssignForAppOK {
	return &WaypointServiceUIBulkUpdateActionAssignForAppOK{}
}
...
type WaypointServiceUIBulkUpdateActionAssignForAppOK struct {
	Payload *models.HashicorpCloudWaypointV20241122UIBulkUpdateActionAssignmentsForAppResponse
}
...
func (o *WaypointServiceUIBulkUpdateActionAssignForAppOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/ui/applications/action-assignments][%d] waypointServiceUiBulkUpdateActionAssignForAppOK %s", 200, payload)
}
...
func (o *WaypointServiceUIBulkUpdateActionAssignForAppOK) GetPayload() *models.HashicorpCloudWaypointV20241122UIBulkUpdateActionAssignmentsForAppResponse {
	return o.Payload
}

func (o *WaypointServiceUIBulkUpdateActionAssignForAppOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.HashicorpCloudWaypointV20241122UIBulkUpdateActionAssignmentsForAppResponse)
...
func NewWaypointServiceUIBulkUpdateActionAssignForAppDefault(code int) *WaypointServiceUIBulkUpdateActionAssignForAppDefault {
	return &WaypointServiceUIBulkUpdateActionAssignForAppDefault{
		_statusCode: code,
	}
}
...
func (o *WaypointServiceUIBulkUpdateActionAssignForAppDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/ui/applications/action-assignments][%d] WaypointService_UI_BulkUpdateActionAssignForApp default %s", o._statusCode, payload)
}
...
func (o *WaypointServiceUIBulkUpdateActionAssignForAppDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
