...
func (o *WaypointServiceDeleteActionConfigOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/actionconfig][%d] waypointServiceDeleteActionConfigOK %s", 200, payload)
}
...
func (o *WaypointServiceDeleteActionConfigDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/actionconfig][%d] WaypointService_DeleteActionConfig default %s", o._statusCode, payload)
}
