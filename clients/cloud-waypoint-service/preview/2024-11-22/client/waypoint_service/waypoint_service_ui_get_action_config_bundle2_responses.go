...
func (o *WaypointServiceUIGetActionConfigBundle2OK) Error() string {
	...
	return fmt.Sprintf("[GET /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/ui/actionconfig/by-name/{action_name}][%d] waypointServiceUiGetActionConfigBundle2OK %s", 200, payload)
}
...
func (o *WaypointServiceUIGetActionConfigBundle2OK) GetPayload() *models.HashicorpCloudWaypointV20241122UIGetActionConfigResponse {
	return o.Payload
}
...
func (o *WaypointServiceUIGetActionConfigBundle2Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/ui/actionconfig/by-name/{action_name}][%d] WaypointService_UI_GetActionConfigBundle2 default %s", o._statusCode, payload)
}
