...
func (o *WaypointServiceGetTFWorkspaceInfo2OK) Error() string {
	...
	return fmt.Sprintf("[GET /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/application/by-name/{application.name}/workspace][%d] waypointServiceGetTFWorkspaceInfo2OK %s", 200, payload)
}
...
func (o *WaypointServiceGetTFWorkspaceInfo2OK) GetPayload() *models.HashicorpCloudWaypointV20241122GetTFWorkspaceInfoResponse {
	return o.Payload
}
...
func (o *WaypointServiceGetTFWorkspaceInfo2Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/application/by-name/{application.name}/workspace][%d] WaypointService_GetTFWorkspaceInfo2 default %s", o._statusCode, payload)
}
