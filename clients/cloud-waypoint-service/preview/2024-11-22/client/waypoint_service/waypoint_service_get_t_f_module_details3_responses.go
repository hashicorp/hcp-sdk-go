...
func (o *WaypointServiceGetTFModuleDetails3Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/tf-module-details/{tfc_namespace}/{name}/{provider}/{module_id}][%d] WaypointService_GetTFModuleDetails3 default %s", o._statusCode, payload)
}
