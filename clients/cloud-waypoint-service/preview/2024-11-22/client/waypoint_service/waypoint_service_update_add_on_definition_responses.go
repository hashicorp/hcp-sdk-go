...
func (o *WaypointServiceUpdateAddOnDefinitionOK) Error() string {
	...
	return fmt.Sprintf("[PUT /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/add-on-definition/{existing_add_on_definition.id}][%d] waypointServiceUpdateAddOnDefinitionOK %s", 200, payload)
}
...
func (o *WaypointServiceUpdateAddOnDefinitionOK) GetPayload() *models.HashicorpCloudWaypointV20241122UpdateAddOnDefinitionResponse {
	return o.Payload
}
...
func (o *WaypointServiceUpdateAddOnDefinitionDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/add-on-definition/{existing_add_on_definition.id}][%d] WaypointService_UpdateAddOnDefinition default %s", o._statusCode, payload)
}
