...
type WaypointServiceUpdateAddOnOK struct {
	Payload *models.HashicorpCloudWaypointV20241122UpdateAddOnResponse
}
...
func (o *WaypointServiceUpdateAddOnOK) Error() string {
	...
	return fmt.Sprintf("[PUT /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/add-on/{existing_add_on.id}][%d] waypointServiceUpdateAddOnOK %s", 200, payload)
}
...
func (o *WaypointServiceUpdateAddOnOK) GetPayload() *models.HashicorpCloudWaypointV20241122UpdateAddOnResponse {
	return o.Payload
}
...
func (o *WaypointServiceUpdateAddOnOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.HashicorpCloudWaypointV20241122UpdateAddOnResponse)
...
func (o *WaypointServiceUpdateAddOnDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/add-on/{existing_add_on.id}][%d] WaypointService_UpdateAddOn default %s", o._statusCode, payload)
}
