...
func (o *WaypointServiceDestroyAddOn2Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/add-on/by-name/{add_on.name}][%d] WaypointService_DestroyAddOn2 default %s", o._statusCode, payload)
}
