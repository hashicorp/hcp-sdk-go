...
func (o *WaypointServiceQueueAgentOperationDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /waypoint/2024-11-22/organizations/{namespace.location.organization_id}/projects/{namespace.location.project_id}/agent/operation:queue][%d] WaypointService_QueueAgentOperation default %s", o._statusCode, payload)
}
