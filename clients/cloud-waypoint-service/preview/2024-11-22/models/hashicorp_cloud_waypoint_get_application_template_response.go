...
func (m *HashicorpCloudWaypointGetApplicationTemplateResponse) validateApplicationTemplate(formats strfmt.Registry) error {
...
func (m *HashicorpCloudWaypointGetApplicationTemplateResponse) contextValidateApplicationTemplate(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudWaypointGetApplicationTemplateResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudWaypointGetApplicationTemplateResponse
