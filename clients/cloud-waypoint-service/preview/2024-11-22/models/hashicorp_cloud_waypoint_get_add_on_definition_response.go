...
// HashicorpCloudWaypointGetAddOnDefinitionResponse GetAddOnDefinitionResponse is the response used to return an existing Add-on
// Definition
//
...
func (m *HashicorpCloudWaypointGetAddOnDefinitionResponse) validateAddOnDefinition(formats strfmt.Registry) error {
...
func (m *HashicorpCloudWaypointGetAddOnDefinitionResponse) contextValidateAddOnDefinition(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudWaypointGetAddOnDefinitionResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudWaypointGetAddOnDefinitionResponse
