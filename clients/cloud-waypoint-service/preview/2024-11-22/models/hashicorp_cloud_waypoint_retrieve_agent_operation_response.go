...
func (m *HashicorpCloudWaypointRetrieveAgentOperationResponse) validateOperation(formats strfmt.Registry) error {
...
func (m *HashicorpCloudWaypointRetrieveAgentOperationResponse) contextValidateOperation(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudWaypointRetrieveAgentOperationResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudWaypointRetrieveAgentOperationResponse
