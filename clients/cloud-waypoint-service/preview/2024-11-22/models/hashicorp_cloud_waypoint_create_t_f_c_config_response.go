...
func (m *HashicorpCloudWaypointCreateTFCConfigResponse) validateTfcConfig(formats strfmt.Registry) error {
...
func (m *HashicorpCloudWaypointCreateTFCConfigResponse) contextValidateTfcConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudWaypointCreateTFCConfigResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudWaypointCreateTFCConfigResponse
