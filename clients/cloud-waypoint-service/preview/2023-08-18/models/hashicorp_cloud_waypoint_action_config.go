...
func (m *HashicorpCloudWaypointActionConfig) validateRequest(formats strfmt.Registry) error {
...
func (m *HashicorpCloudWaypointActionConfig) contextValidateRequest(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudWaypointActionConfig) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudWaypointActionConfig
