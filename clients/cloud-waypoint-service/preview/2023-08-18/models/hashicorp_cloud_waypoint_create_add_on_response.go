...
func (m *HashicorpCloudWaypointCreateAddOnResponse) validateAddOn(formats strfmt.Registry) error {
...
func (m *HashicorpCloudWaypointCreateAddOnResponse) contextValidateAddOn(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudWaypointCreateAddOnResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudWaypointCreateAddOnResponse
