...
func (m *HashicorpCloudWaypointGetApplicationResponse) validateApplication(formats strfmt.Registry) error {
...
func (m *HashicorpCloudWaypointGetApplicationResponse) contextValidateApplication(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudWaypointGetApplicationResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudWaypointGetApplicationResponse
