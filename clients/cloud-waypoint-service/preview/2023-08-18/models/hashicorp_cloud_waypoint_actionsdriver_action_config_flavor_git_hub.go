...
// HashicorpCloudWaypointActionsdriverActionConfigFlavorGitHub GitHub mode is configured to do various operations on a GitHub repositories
// defined Workflows.
//
...
func (m *HashicorpCloudWaypointActionsdriverActionConfigFlavorGitHub) validateMethod(formats strfmt.Registry) error {
...
func (m *HashicorpCloudWaypointActionsdriverActionConfigFlavorGitHub) contextValidateMethod(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudWaypointActionsdriverActionConfigFlavorGitHub) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudWaypointActionsdriverActionConfigFlavorGitHub
