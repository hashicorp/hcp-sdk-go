...
// HashicorpCloudWaypointPaginationResponse PaginationResponse is the response holding the page tokens for a paginated
// list response.
//
...
func (m *HashicorpCloudWaypointPaginationResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudWaypointPaginationResponse
