...
func (m *HashicorpCloudWaypointActionRunScope) validateApplication(formats strfmt.Registry) error {
...
func (m *HashicorpCloudWaypointActionRunScope) contextValidateApplication(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudWaypointActionRunScope) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudWaypointActionRunScope
