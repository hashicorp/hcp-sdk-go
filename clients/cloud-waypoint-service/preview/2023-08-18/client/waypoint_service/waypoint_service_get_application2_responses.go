...
func (o *WaypointServiceGetApplication2OK) Error() string {
	...
	return fmt.Sprintf("[GET /waypoint/2023-08-18/namespace/{namespace.id}/applications/by-name/{application.name}][%d] waypointServiceGetApplication2OK %s", 200, payload)
}
...
func (o *WaypointServiceGetApplication2Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /waypoint/2023-08-18/namespace/{namespace.id}/applications/by-name/{application.name}][%d] WaypointService_GetApplication2 default %s", o._statusCode, payload)
}
