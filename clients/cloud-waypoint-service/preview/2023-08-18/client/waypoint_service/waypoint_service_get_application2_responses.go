...
func (o *WaypointServiceGetApplication2OK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2023-08-18/namespace/{namespace.id}/applications/by-name/{application.name}][%d] waypointServiceGetApplication2OK  %+v", 200, o.Payload)
}
...
func (o *WaypointServiceGetApplication2Default) Error() string {
	return fmt.Sprintf("[GET /waypoint/2023-08-18/namespace/{namespace.id}/applications/by-name/{application.name}][%d] WaypointService_GetApplication2 default  %+v", o._statusCode, o.Payload)
}
...
func (o *WaypointServiceGetApplication2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
