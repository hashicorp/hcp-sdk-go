...
func (o *WaypointServiceUpdateApplicationsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewWaypointServiceUpdateApplicationsListOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewWaypointServiceUpdateApplicationsListDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewWaypointServiceUpdateApplicationsListOK() *WaypointServiceUpdateApplicationsListOK {
	return &WaypointServiceUpdateApplicationsListOK{}
}
...
func (o *WaypointServiceUpdateApplicationsListOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this waypoint service update applications list o k response has a 3xx status code
func (o *WaypointServiceUpdateApplicationsListOK) IsRedirect() bool {
	return false
}
...
func (o *WaypointServiceUpdateApplicationsListOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the waypoint service update applications list o k response
func (o *WaypointServiceUpdateApplicationsListOK) Code() int {
	return 200
}

func (o *WaypointServiceUpdateApplicationsListOK) Error() string {
	return fmt.Sprintf("[PATCH /waypoint/2023-08-18/namespace/{namespace.id}/applications][%d] waypointServiceUpdateApplicationsListOK  %+v", 200, o.Payload)
}

func (o *WaypointServiceUpdateApplicationsListOK) String() string {
	return fmt.Sprintf("[PATCH /waypoint/2023-08-18/namespace/{namespace.id}/applications][%d] waypointServiceUpdateApplicationsListOK  %+v", 200, o.Payload)
}

func (o *WaypointServiceUpdateApplicationsListOK) GetPayload() models.HashicorpCloudWaypointUpdateApplicationsListResponse {
	return o.Payload
}

func (o *WaypointServiceUpdateApplicationsListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewWaypointServiceUpdateApplicationsListDefault(code int) *WaypointServiceUpdateApplicationsListDefault {
	return &WaypointServiceUpdateApplicationsListDefault{
		_statusCode: code,
	}
}
...
func (o *WaypointServiceUpdateApplicationsListDefault) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this waypoint service update applications list default response has a 3xx status code
func (o *WaypointServiceUpdateApplicationsListDefault) IsRedirect() bool {
...
func (o *WaypointServiceUpdateApplicationsListDefault) IsClientError() bool {
...
func (o *WaypointServiceUpdateApplicationsListDefault) IsServerError() bool {
...
func (o *WaypointServiceUpdateApplicationsListDefault) IsCode(code int) bool {
	return o._statusCode == code
}

// Code gets the status code for the waypoint service update applications list default response
func (o *WaypointServiceUpdateApplicationsListDefault) Code() int {
	return o._statusCode
}

func (o *WaypointServiceUpdateApplicationsListDefault) Error() string {
	return fmt.Sprintf("[PATCH /waypoint/2023-08-18/namespace/{namespace.id}/applications][%d] WaypointService_UpdateApplicationsList default  %+v", o._statusCode, o.Payload)
}

func (o *WaypointServiceUpdateApplicationsListDefault) String() string {
	return fmt.Sprintf("[PATCH /waypoint/2023-08-18/namespace/{namespace.id}/applications][%d] WaypointService_UpdateApplicationsList default  %+v", o._statusCode, o.Payload)
}

func (o *WaypointServiceUpdateApplicationsListDefault) GetPayload() *cloud.GoogleRPCStatus {
	return o.Payload
}

func (o *WaypointServiceUpdateApplicationsListDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
