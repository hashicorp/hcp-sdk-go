...
type WaypointServiceUICreateActionConfigWithVarsParams struct {
	...
	// Body.
	Body *models.HashicorpCloudWaypointWaypointServiceUICreateActionConfigWithVarsBody
...
func (o *WaypointServiceUICreateActionConfigWithVarsParams) WithBody(body *models.HashicorpCloudWaypointWaypointServiceUICreateActionConfigWithVarsBody) *WaypointServiceUICreateActionConfigWithVarsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the waypoint service UI create action config with vars params
func (o *WaypointServiceUICreateActionConfigWithVarsParams) SetBody(body *models.HashicorpCloudWaypointWaypointServiceUICreateActionConfigWithVarsBody) {
	o.Body = body
}

// WithNamespaceID adds the namespaceID to the waypoint service UI create action config with vars params
func (o *WaypointServiceUICreateActionConfigWithVarsParams) WithNamespaceID(namespaceID string) *WaypointServiceUICreateActionConfigWithVarsParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint service UI create action config with vars params
func (o *WaypointServiceUICreateActionConfigWithVarsParams) SetNamespaceID(namespaceID string) {
