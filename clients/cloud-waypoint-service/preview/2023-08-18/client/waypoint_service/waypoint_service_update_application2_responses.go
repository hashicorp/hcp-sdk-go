...
func (o *WaypointServiceUpdateApplication2OK) Error() string {
	...
	return fmt.Sprintf("[PUT /waypoint/2023-08-18/namespace/{namespace.id}/applications/by-name/{application.name}][%d] waypointServiceUpdateApplication2OK %s", 200, payload)
}
...
func (o *WaypointServiceUpdateApplication2Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /waypoint/2023-08-18/namespace/{namespace.id}/applications/by-name/{application.name}][%d] WaypointService_UpdateApplication2 default %s", o._statusCode, payload)
}
