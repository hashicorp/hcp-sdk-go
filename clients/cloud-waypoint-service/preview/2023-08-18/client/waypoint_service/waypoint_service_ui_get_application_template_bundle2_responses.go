...
func (o *WaypointServiceUIGetApplicationTemplateBundle2OK) Error() string {
	...
	return fmt.Sprintf("[GET /waypoint/2023-08-18/namespace/{namespace.id}/ui/application-templates/by-name/{application_template.name}][%d] waypointServiceUiGetApplicationTemplateBundle2OK %s", 200, payload)
}
...
func (o *WaypointServiceUIGetApplicationTemplateBundle2Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /waypoint/2023-08-18/namespace/{namespace.id}/ui/application-templates/by-name/{application_template.name}][%d] WaypointService_UI_GetApplicationTemplateBundle2 default %s", o._statusCode, payload)
}
