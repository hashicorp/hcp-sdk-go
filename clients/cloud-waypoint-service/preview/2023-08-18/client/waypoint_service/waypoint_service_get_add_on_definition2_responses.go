...
func (o *WaypointServiceGetAddOnDefinition2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewWaypointServiceGetAddOnDefinition2OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewWaypointServiceGetAddOnDefinition2Default(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewWaypointServiceGetAddOnDefinition2OK() *WaypointServiceGetAddOnDefinition2OK {
	return &WaypointServiceGetAddOnDefinition2OK{}
}
...
func (o *WaypointServiceGetAddOnDefinition2OK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2023-08-18/namespace/{namespace.id}/add-on-definition/by-name/{add_on_definition.name}][%d] waypointServiceGetAddOnDefinition2OK  %+v", 200, o.Payload)
}
...
func NewWaypointServiceGetAddOnDefinition2Default(code int) *WaypointServiceGetAddOnDefinition2Default {
	return &WaypointServiceGetAddOnDefinition2Default{
		_statusCode: code,
	}
}
...
func (o *WaypointServiceGetAddOnDefinition2Default) Error() string {
	return fmt.Sprintf("[GET /waypoint/2023-08-18/namespace/{namespace.id}/add-on-definition/by-name/{add_on_definition.name}][%d] WaypointService_GetAddOnDefinition2 default  %+v", o._statusCode, o.Payload)
}
...
func (o *WaypointServiceGetAddOnDefinition2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}

func (o *WaypointServiceGetAddOnDefinition2Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
