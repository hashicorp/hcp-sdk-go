...
func (o *WaypointServiceDeleteApplicationTemplate2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewWaypointServiceDeleteApplicationTemplate2OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewWaypointServiceDeleteApplicationTemplate2Default(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewWaypointServiceDeleteApplicationTemplate2OK() *WaypointServiceDeleteApplicationTemplate2OK {
	return &WaypointServiceDeleteApplicationTemplate2OK{}
}
...
func (o *WaypointServiceDeleteApplicationTemplate2OK) Error() string {
	return fmt.Sprintf("[DELETE /waypoint/2023-08-18/namespace/{namespace.id}/application-templates/by-name/{application_template.name}][%d] waypointServiceDeleteApplicationTemplate2OK  %+v", 200, o.Payload)
}
...
func (o *WaypointServiceDeleteApplicationTemplate2OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewWaypointServiceDeleteApplicationTemplate2Default(code int) *WaypointServiceDeleteApplicationTemplate2Default {
	return &WaypointServiceDeleteApplicationTemplate2Default{
		_statusCode: code,
	}
}
...
func (o *WaypointServiceDeleteApplicationTemplate2Default) Error() string {
	return fmt.Sprintf("[DELETE /waypoint/2023-08-18/namespace/{namespace.id}/application-templates/by-name/{application_template.name}][%d] WaypointService_DeleteApplicationTemplate2 default  %+v", o._statusCode, o.Payload)
}
...
func (o *WaypointServiceDeleteApplicationTemplate2Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
