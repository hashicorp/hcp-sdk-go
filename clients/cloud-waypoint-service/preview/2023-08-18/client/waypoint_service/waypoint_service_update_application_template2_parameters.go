...
func (o *WaypointServiceUpdateApplicationTemplate2Params) WithBody(body *models.HashicorpCloudWaypointWaypointServiceUpdateApplicationTemplateBody) *WaypointServiceUpdateApplicationTemplate2Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the waypoint service update application template2 params
func (o *WaypointServiceUpdateApplicationTemplate2Params) SetBody(body *models.HashicorpCloudWaypointWaypointServiceUpdateApplicationTemplateBody) {
	o.Body = body
}
...
func (o *WaypointServiceUpdateApplicationTemplate2Params) WithNamespaceID(namespaceID string) *WaypointServiceUpdateApplicationTemplate2Params {
