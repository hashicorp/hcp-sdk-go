...
// Code gets the status code for the waypoint get pipeline run2 o k response
func (o *WaypointGetPipelineRun2OK) Code() int {
	return 200
}

func (o *WaypointGetPipelineRun2OK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/pipeline/{pipeline.id}/run/{sequence}][%d] waypointGetPipelineRun2OK  %+v", 200, o.Payload)
}
...
func (o *WaypointGetPipelineRun2Default) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/pipeline/{pipeline.id}/run/{sequence}][%d] Waypoint_GetPipelineRun2 default  %+v", o._statusCode, o.Payload)
}
...
func (o *WaypointGetPipelineRun2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
