...
// Code gets the status code for the waypoint list runners o k response
func (o *WaypointListRunnersOK) Code() int {
	return 200
}
...
func (o *WaypointListRunnersDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
