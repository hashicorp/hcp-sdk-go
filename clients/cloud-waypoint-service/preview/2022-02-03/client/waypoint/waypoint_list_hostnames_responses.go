...
// Code gets the status code for the waypoint list hostnames o k response
func (o *WaypointListHostnamesOK) Code() int {
	return 200
}
...
func (o *WaypointListHostnamesDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
