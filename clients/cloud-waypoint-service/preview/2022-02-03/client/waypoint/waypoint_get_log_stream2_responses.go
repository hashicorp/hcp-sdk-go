...
// Code gets the status code for the waypoint get log stream2 o k response
func (o *WaypointGetLogStream2OK) Code() int {
	return 200
}
...
func (o *WaypointGetLogStream2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
