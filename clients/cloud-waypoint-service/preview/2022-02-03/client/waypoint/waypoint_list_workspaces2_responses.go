...
// Code gets the status code for the waypoint list workspaces2 o k response
func (o *WaypointListWorkspaces2OK) Code() int {
	return 200
}
...
func (o *WaypointListWorkspaces2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
