...
// Code gets the status code for the waypoint get on demand runner config o k response
func (o *WaypointGetOnDemandRunnerConfigOK) Code() int {
	return 200
}
...
func (o *WaypointGetOnDemandRunnerConfigDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
