...
// Code gets the status code for the waypoint Ui get project o k response
func (o *WaypointUIGetProjectOK) Code() int {
	return 200
}
...
func (o *WaypointUIGetProjectDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
