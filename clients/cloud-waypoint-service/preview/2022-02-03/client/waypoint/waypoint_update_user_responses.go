...
// Code gets the status code for the waypoint update user o k response
func (o *WaypointUpdateUserOK) Code() int {
	return 200
}
...
func (o *WaypointUpdateUserDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
