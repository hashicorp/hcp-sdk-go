...
// Code gets the status code for the waypoint delete user o k response
func (o *WaypointDeleteUserOK) Code() int {
	return 200
}
...
func (o *WaypointDeleteUserDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
