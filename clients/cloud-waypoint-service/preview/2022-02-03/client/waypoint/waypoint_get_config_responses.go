...
// Code gets the status code for the waypoint get config o k response
func (o *WaypointGetConfigOK) Code() int {
	return 200
}
...
func (o *WaypointGetConfigDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
