...
// Code gets the status code for the waypoint list auth methods o k response
func (o *WaypointListAuthMethodsOK) Code() int {
	return 200
}
...
func (o *WaypointListAuthMethodsDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
