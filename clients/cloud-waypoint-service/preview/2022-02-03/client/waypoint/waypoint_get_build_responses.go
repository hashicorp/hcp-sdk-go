...
// Code gets the status code for the waypoint get build o k response
func (o *WaypointGetBuildOK) Code() int {
	return 200
}
...
func (o *WaypointGetBuildDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
