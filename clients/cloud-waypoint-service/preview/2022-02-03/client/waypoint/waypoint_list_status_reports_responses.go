...
// Code gets the status code for the waypoint list status reports o k response
func (o *WaypointListStatusReportsOK) Code() int {
	return 200
}
...
func (o *WaypointListStatusReportsDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
