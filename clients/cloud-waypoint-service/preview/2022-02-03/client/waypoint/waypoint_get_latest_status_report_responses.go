...
// Code gets the status code for the waypoint get latest status report o k response
func (o *WaypointGetLatestStatusReportOK) Code() int {
	return 200
}
...
func (o *WaypointGetLatestStatusReportDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
