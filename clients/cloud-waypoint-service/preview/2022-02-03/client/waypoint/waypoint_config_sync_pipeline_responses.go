...
// Code gets the status code for the waypoint config sync pipeline o k response
func (o *WaypointConfigSyncPipelineOK) Code() int {
	return 200
}

func (o *WaypointConfigSyncPipelineOK) Error() string {
	return fmt.Sprintf("[POST /waypoint/2022-02-03/namespace/{namespace_id}/project/{project.project}/config-sync-pipeline][%d] waypointConfigSyncPipelineOK  %+v", 200, o.Payload)
}
...
func (o *WaypointConfigSyncPipelineDefault) Error() string {
	return fmt.Sprintf("[POST /waypoint/2022-02-03/namespace/{namespace_id}/project/{project.project}/config-sync-pipeline][%d] Waypoint_ConfigSyncPipeline default  %+v", o._statusCode, o.Payload)
}
...
func (o *WaypointConfigSyncPipelineDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
