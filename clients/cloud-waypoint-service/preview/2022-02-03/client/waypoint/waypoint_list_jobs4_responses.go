...
// Code gets the status code for the waypoint list jobs4 o k response
func (o *WaypointListJobs4OK) Code() int {
	return 200
}
...
func (o *WaypointListJobs4Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
