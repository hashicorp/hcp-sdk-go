...
// Code gets the status code for the waypoint list triggers3 o k response
func (o *WaypointListTriggers3OK) Code() int {
	return 200
}
...
func (o *WaypointListTriggers3Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
