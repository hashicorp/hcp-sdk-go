...
// Code gets the status code for the waypoint get config3 o k response
func (o *WaypointGetConfig3OK) Code() int {
	return 200
}
...
func (o *WaypointGetConfig3Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
