...
// Code gets the status code for the waypoint get latest pushed artifact2 o k response
func (o *WaypointGetLatestPushedArtifact2OK) Code() int {
	return 200
}
...
func (o *WaypointGetLatestPushedArtifact2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
