...
// Code gets the status code for the waypoint cancel job o k response
func (o *WaypointCancelJobOK) Code() int {
	return 200
}
...
func (o *WaypointCancelJobDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
