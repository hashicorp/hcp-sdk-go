...
// Code gets the status code for the waypoint delete auth method o k response
func (o *WaypointDeleteAuthMethodOK) Code() int {
	return 200
}
...
func (o *WaypointDeleteAuthMethodDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
