...
// Code gets the status code for the waypoint get project o k response
func (o *WaypointGetProjectOK) Code() int {
	return 200
}
...
func (o *WaypointGetProjectDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
