...
// Code gets the status code for the waypoint adopt runner o k response
func (o *WaypointAdoptRunnerOK) Code() int {
	return 200
}
...
func (o *WaypointAdoptRunnerDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
