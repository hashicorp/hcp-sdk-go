...
// WithNamespaceID adds the namespaceID to the waypoint config sync pipeline params
func (o *WaypointConfigSyncPipelineParams) WithNamespaceID(namespaceID string) *WaypointConfigSyncPipelineParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint config sync pipeline params
func (o *WaypointConfigSyncPipelineParams) SetNamespaceID(namespaceID string) {
