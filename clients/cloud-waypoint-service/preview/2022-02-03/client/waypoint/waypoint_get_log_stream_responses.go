...
// Code gets the status code for the waypoint get log stream o k response
func (o *WaypointGetLogStreamOK) Code() int {
	return 200
}
...
func (o *WaypointGetLogStreamDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
