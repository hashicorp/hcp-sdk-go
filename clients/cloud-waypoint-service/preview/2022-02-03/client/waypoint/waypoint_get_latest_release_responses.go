...
// Code gets the status code for the waypoint get latest release o k response
func (o *WaypointGetLatestReleaseOK) Code() int {
	return 200
}
...
func (o *WaypointGetLatestReleaseDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
