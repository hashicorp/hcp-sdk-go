...
// Code gets the status code for the waypoint set config o k response
func (o *WaypointSetConfigOK) Code() int {
	return 200
}
...
func (o *WaypointSetConfigDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
