...
// Code gets the status code for the waypoint validate job o k response
func (o *WaypointValidateJobOK) Code() int {
	return 200
}

func (o *WaypointValidateJobOK) Error() string {
	return fmt.Sprintf("[POST /waypoint/2022-02-03/namespace/{namespace_id}/jobs/validateJob][%d] waypointValidateJobOK  %+v", 200, o.Payload)
}
...
func (o *WaypointValidateJobDefault) Error() string {
	return fmt.Sprintf("[POST /waypoint/2022-02-03/namespace/{namespace_id}/jobs/validateJob][%d] Waypoint_ValidateJob default  %+v", o._statusCode, o.Payload)
}
...
func (o *WaypointValidateJobDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
