...
// Code gets the status code for the waypoint create hostname2 o k response
func (o *WaypointCreateHostname2OK) Code() int {
	return 200
}
...
func (o *WaypointCreateHostname2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
