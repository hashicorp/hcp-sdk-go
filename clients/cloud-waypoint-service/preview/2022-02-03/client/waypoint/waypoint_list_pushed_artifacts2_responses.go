...
// Code gets the status code for the waypoint list pushed artifacts2 o k response
func (o *WaypointListPushedArtifacts2OK) Code() int {
	return 200
}
...
func (o *WaypointListPushedArtifacts2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
