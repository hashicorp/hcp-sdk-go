...
// Code gets the status code for the waypoint get task o k response
func (o *WaypointGetTaskOK) Code() int {
	return 200
}
...
func (o *WaypointGetTaskDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
