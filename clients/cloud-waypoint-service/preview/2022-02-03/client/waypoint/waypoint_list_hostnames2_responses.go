...
// Code gets the status code for the waypoint list hostnames2 o k response
func (o *WaypointListHostnames2OK) Code() int {
	return 200
}
...
func (o *WaypointListHostnames2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
