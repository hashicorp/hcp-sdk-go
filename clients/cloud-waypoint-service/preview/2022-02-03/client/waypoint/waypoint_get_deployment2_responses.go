...
// Code gets the status code for the waypoint get deployment2 o k response
func (o *WaypointGetDeployment2OK) Code() int {
	return 200
}
...
func (o *WaypointGetDeployment2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
