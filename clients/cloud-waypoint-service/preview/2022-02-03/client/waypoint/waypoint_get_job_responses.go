...
// Code gets the status code for the waypoint get job o k response
func (o *WaypointGetJobOK) Code() int {
	return 200
}
...
func (o *WaypointGetJobDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
