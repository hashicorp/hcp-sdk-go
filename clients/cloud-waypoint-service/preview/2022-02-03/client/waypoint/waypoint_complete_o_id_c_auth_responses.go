...
// Code gets the status code for the waypoint complete o Id c auth o k response
func (o *WaypointCompleteOIDCAuthOK) Code() int {
	return 200
}
...
func (o *WaypointCompleteOIDCAuthDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
