...
// Code gets the status code for the waypoint set server config o k response
func (o *WaypointSetServerConfigOK) Code() int {
	return 200
}
...
func (o *WaypointSetServerConfigDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
