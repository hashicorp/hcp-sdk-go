...
// Code gets the status code for the waypoint get on demand runner config2 o k response
func (o *WaypointGetOnDemandRunnerConfig2OK) Code() int {
	return 200
}
...
func (o *WaypointGetOnDemandRunnerConfig2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
