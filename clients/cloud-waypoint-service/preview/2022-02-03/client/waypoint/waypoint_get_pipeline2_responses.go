...
// Code gets the status code for the waypoint get pipeline2 o k response
func (o *WaypointGetPipeline2OK) Code() int {
	return 200
}

func (o *WaypointGetPipeline2OK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/pipeline/{pipeline.id}][%d] waypointGetPipeline2OK  %+v", 200, o.Payload)
}
...
func (o *WaypointGetPipeline2Default) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/pipeline/{pipeline.id}][%d] Waypoint_GetPipeline2 default  %+v", o._statusCode, o.Payload)
}
...
func (o *WaypointGetPipeline2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
