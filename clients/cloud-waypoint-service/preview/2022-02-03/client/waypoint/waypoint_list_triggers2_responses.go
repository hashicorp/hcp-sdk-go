...
// Code gets the status code for the waypoint list triggers2 o k response
func (o *WaypointListTriggers2OK) Code() int {
	return 200
}
...
func (o *WaypointListTriggers2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
