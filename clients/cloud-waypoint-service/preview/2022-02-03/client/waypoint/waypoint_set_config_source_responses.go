...
// Code gets the status code for the waypoint set config source o k response
func (o *WaypointSetConfigSourceOK) Code() int {
	return 200
}
...
func (o *WaypointSetConfigSourceDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
