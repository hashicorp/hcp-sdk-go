...
// Code gets the status code for the waypoint forget runner o k response
func (o *WaypointForgetRunnerOK) Code() int {
	return 200
}
...
func (o *WaypointForgetRunnerDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
