...
// Code gets the status code for the waypoint create hostname o k response
func (o *WaypointCreateHostnameOK) Code() int {
	return 200
}
...
func (o *WaypointCreateHostnameDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
