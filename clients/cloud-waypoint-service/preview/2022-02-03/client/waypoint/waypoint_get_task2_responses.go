...
// Code gets the status code for the waypoint get task2 o k response
func (o *WaypointGetTask2OK) Code() int {
	return 200
}
...
func (o *WaypointGetTask2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
