...
// Code gets the status code for the waypoint upsert auth method o k response
func (o *WaypointUpsertAuthMethodOK) Code() int {
	return 200
}
...
func (o *WaypointUpsertAuthMethodDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
