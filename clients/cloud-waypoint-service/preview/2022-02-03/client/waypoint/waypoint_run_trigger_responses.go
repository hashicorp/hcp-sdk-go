...
// Code gets the status code for the waypoint run trigger o k response
func (o *WaypointRunTriggerOK) Code() int {
	return 200
}
...
func (o *WaypointRunTriggerDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
