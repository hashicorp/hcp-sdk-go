...
// Code gets the status code for the waypoint start exec stream o k response
func (o *WaypointStartExecStreamOK) Code() int {
	return 200
}
...
func (o *WaypointStartExecStreamDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
