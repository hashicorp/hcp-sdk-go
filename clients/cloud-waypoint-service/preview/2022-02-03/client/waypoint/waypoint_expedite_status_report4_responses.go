...
// Code gets the status code for the waypoint expedite status report4 o k response
func (o *WaypointExpediteStatusReport4OK) Code() int {
	return 200
}
...
func (o *WaypointExpediteStatusReport4Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
