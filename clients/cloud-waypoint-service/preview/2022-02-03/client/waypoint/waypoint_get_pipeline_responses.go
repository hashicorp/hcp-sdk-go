...
// Code gets the status code for the waypoint get pipeline o k response
func (o *WaypointGetPipelineOK) Code() int {
	return 200
}

func (o *WaypointGetPipelineOK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/project/{pipeline.owner.project.project}/pipeline/{pipeline.owner.pipeline_name}][%d] waypointGetPipelineOK  %+v", 200, o.Payload)
}
...
func (o *WaypointGetPipelineDefault) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/project/{pipeline.owner.project.project}/pipeline/{pipeline.owner.pipeline_name}][%d] Waypoint_GetPipeline default  %+v", o._statusCode, o.Payload)
}
...
func (o *WaypointGetPipelineDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
