...
// Code gets the status code for the waypoint list triggers4 o k response
func (o *WaypointListTriggers4OK) Code() int {
	return 200
}
...
func (o *WaypointListTriggers4Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
