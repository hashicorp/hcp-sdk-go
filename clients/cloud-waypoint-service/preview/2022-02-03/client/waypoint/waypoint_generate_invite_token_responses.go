...
// Code gets the status code for the waypoint generate invite token o k response
func (o *WaypointGenerateInviteTokenOK) Code() int {
	return 200
}
...
func (o *WaypointGenerateInviteTokenDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
