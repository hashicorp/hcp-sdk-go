...
// Code gets the status code for the waypoint upsert on demand runner config o k response
func (o *WaypointUpsertOnDemandRunnerConfigOK) Code() int {
	return 200
}
...
func (o *WaypointUpsertOnDemandRunnerConfigDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
