...
// Code gets the status code for the waypoint expedite status report2 o k response
func (o *WaypointExpediteStatusReport2OK) Code() int {
	return 200
}
...
func (o *WaypointExpediteStatusReport2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
