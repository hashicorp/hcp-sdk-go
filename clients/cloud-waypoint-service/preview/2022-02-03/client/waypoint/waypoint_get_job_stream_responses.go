...
// Code gets the status code for the waypoint get job stream o k response
func (o *WaypointGetJobStreamOK) Code() int {
	return 200
}
...
func (o *WaypointGetJobStreamDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
