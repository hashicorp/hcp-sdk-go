...
// Code gets the status code for the waypoint list o Id c auth methods o k response
func (o *WaypointListOIDCAuthMethodsOK) Code() int {
	return 200
}
...
func (o *WaypointListOIDCAuthMethodsDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
