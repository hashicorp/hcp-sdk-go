...
// WithNamespaceID adds the namespaceID to the waypoint get latest pipeline run params
func (o *WaypointGetLatestPipelineRunParams) WithNamespaceID(namespaceID string) *WaypointGetLatestPipelineRunParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get latest pipeline run params
func (o *WaypointGetLatestPipelineRunParams) SetNamespaceID(namespaceID string) {
