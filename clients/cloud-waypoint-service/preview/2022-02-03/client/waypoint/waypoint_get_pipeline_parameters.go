...
// WithNamespaceID adds the namespaceID to the waypoint get pipeline params
func (o *WaypointGetPipelineParams) WithNamespaceID(namespaceID string) *WaypointGetPipelineParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get pipeline params
func (o *WaypointGetPipelineParams) SetNamespaceID(namespaceID string) {
