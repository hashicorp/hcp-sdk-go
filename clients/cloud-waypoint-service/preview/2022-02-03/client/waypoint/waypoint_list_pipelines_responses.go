...
// Code gets the status code for the waypoint list pipelines o k response
func (o *WaypointListPipelinesOK) Code() int {
	return 200
}

func (o *WaypointListPipelinesOK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/project/{project.project}/pipelines][%d] waypointListPipelinesOK  %+v", 200, o.Payload)
}
...
func (o *WaypointListPipelinesDefault) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/project/{project.project}/pipelines][%d] Waypoint_ListPipelines default  %+v", o._statusCode, o.Payload)
}
...
func (o *WaypointListPipelinesDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
