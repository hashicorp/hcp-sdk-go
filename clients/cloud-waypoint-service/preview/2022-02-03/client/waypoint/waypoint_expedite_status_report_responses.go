...
// Code gets the status code for the waypoint expedite status report o k response
func (o *WaypointExpediteStatusReportOK) Code() int {
	return 200
}
...
func (o *WaypointExpediteStatusReportDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
