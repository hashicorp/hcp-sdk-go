...
// Code gets the status code for the waypoint list status reports2 o k response
func (o *WaypointListStatusReports2OK) Code() int {
	return 200
}
...
func (o *WaypointListStatusReports2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
