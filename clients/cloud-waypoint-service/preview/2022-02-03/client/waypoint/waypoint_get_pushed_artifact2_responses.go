...
// Code gets the status code for the waypoint get pushed artifact2 o k response
func (o *WaypointGetPushedArtifact2OK) Code() int {
	return 200
}
...
func (o *WaypointGetPushedArtifact2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
