...
// Code gets the status code for the waypoint get deployment o k response
func (o *WaypointGetDeploymentOK) Code() int {
	return 200
}
...
func (o *WaypointGetDeploymentDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
