...
// Code gets the status code for the waypoint list workspaces3 o k response
func (o *WaypointListWorkspaces3OK) Code() int {
	return 200
}
...
func (o *WaypointListWorkspaces3Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
