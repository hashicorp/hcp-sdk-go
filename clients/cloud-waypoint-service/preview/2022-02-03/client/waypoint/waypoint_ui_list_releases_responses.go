...
// Code gets the status code for the waypoint Ui list releases o k response
func (o *WaypointUIListReleasesOK) Code() int {
	return 200
}

func (o *WaypointUIListReleasesOK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/ui/project/{application.project}/application/{application.application}/releases][%d] waypointUiListReleasesOK  %+v", 200, o.Payload)
}
...
func (o *WaypointUIListReleasesDefault) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/ui/project/{application.project}/application/{application.application}/releases][%d] Waypoint_UI_ListReleases default  %+v", o._statusCode, o.Payload)
}
...
func (o *WaypointUIListReleasesDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
