...
// Code gets the status code for the waypoint get latest pipeline run2 o k response
func (o *WaypointGetLatestPipelineRun2OK) Code() int {
	return 200
}

func (o *WaypointGetLatestPipelineRun2OK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/pipeline/{pipeline.id}/latest-run][%d] waypointGetLatestPipelineRun2OK  %+v", 200, o.Payload)
}
...
func (o *WaypointGetLatestPipelineRun2Default) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/pipeline/{pipeline.id}/latest-run][%d] Waypoint_GetLatestPipelineRun2 default  %+v", o._statusCode, o.Payload)
}
...
func (o *WaypointGetLatestPipelineRun2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
