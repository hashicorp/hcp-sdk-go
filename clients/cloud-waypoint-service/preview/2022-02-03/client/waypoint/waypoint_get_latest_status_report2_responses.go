...
// Code gets the status code for the waypoint get latest status report2 o k response
func (o *WaypointGetLatestStatusReport2OK) Code() int {
	return 200
}
...
func (o *WaypointGetLatestStatusReport2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
