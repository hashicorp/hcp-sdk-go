...
// Code gets the status code for the waypoint get latest release2 o k response
func (o *WaypointGetLatestRelease2OK) Code() int {
	return 200
}
...
func (o *WaypointGetLatestRelease2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
