...
// Code gets the status code for the waypoint list deployments2 o k response
func (o *WaypointListDeployments2OK) Code() int {
	return 200
}
...
func (o *WaypointListDeployments2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
