...
// Code gets the status code for the waypoint get latest build2 o k response
func (o *WaypointGetLatestBuild2OK) Code() int {
	return 200
}
...
func (o *WaypointGetLatestBuild2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
