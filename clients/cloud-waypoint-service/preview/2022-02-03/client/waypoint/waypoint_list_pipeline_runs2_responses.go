...
// Code gets the status code for the waypoint list pipeline runs2 o k response
func (o *WaypointListPipelineRuns2OK) Code() int {
	return 200
}

func (o *WaypointListPipelineRuns2OK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/pipeline/{pipeline.id}/runs][%d] waypointListPipelineRuns2OK  %+v", 200, o.Payload)
}
...
func (o *WaypointListPipelineRuns2Default) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/pipeline/{pipeline.id}/runs][%d] Waypoint_ListPipelineRuns2 default  %+v", o._statusCode, o.Payload)
}
...
func (o *WaypointListPipelineRuns2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
