...
// Code gets the status code for the waypoint delete user2 o k response
func (o *WaypointDeleteUser2OK) Code() int {
	return 200
}
...
func (o *WaypointDeleteUser2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
