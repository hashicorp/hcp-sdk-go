...
// Code gets the status code for the waypoint expedite status report3 o k response
func (o *WaypointExpediteStatusReport3OK) Code() int {
	return 200
}
...
func (o *WaypointExpediteStatusReport3Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
