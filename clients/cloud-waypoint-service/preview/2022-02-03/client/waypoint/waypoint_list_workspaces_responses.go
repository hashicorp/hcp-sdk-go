...
// Code gets the status code for the waypoint list workspaces o k response
func (o *WaypointListWorkspacesOK) Code() int {
	return 200
}
...
func (o *WaypointListWorkspacesDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
