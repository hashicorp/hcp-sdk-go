...
// Code gets the status code for the waypoint get workspace o k response
func (o *WaypointGetWorkspaceOK) Code() int {
	return 200
}
...
func (o *WaypointGetWorkspaceDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
