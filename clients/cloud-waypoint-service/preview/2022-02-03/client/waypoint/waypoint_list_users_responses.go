...
// Code gets the status code for the waypoint list users o k response
func (o *WaypointListUsersOK) Code() int {
	return 200
}
...
func (o *WaypointListUsersDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
