...
// WithPipelineRootPipelineID adds the pipelineRootPipelineID to the waypoint list jobs params
func (o *WaypointListJobsParams) WithPipelineRootPipelineID(pipelineRootPipelineID *string) *WaypointListJobsParams {
	o.SetPipelineRootPipelineID(pipelineRootPipelineID)
	return o
}

// SetPipelineRootPipelineID adds the pipelineRootPipelineId to the waypoint list jobs params
func (o *WaypointListJobsParams) SetPipelineRootPipelineID(pipelineRootPipelineID *string) {
	o.PipelineRootPipelineID = pipelineRootPipelineID
}

// WithPipelineRootPipelineName adds the pipelineRootPipelineName to the waypoint list jobs params
func (o *WaypointListJobsParams) WithPipelineRootPipelineName(pipelineRootPipelineName *string) *WaypointListJobsParams {
	o.SetPipelineRootPipelineName(pipelineRootPipelineName)
	return o
}

// SetPipelineRootPipelineName adds the pipelineRootPipelineName to the waypoint list jobs params
func (o *WaypointListJobsParams) SetPipelineRootPipelineName(pipelineRootPipelineName *string) {
