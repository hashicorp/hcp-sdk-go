...
// WithNamespaceID adds the namespaceID to the waypoint get pipeline run params
func (o *WaypointGetPipelineRunParams) WithNamespaceID(namespaceID string) *WaypointGetPipelineRunParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get pipeline run params
func (o *WaypointGetPipelineRunParams) SetNamespaceID(namespaceID string) {
