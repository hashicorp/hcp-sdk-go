...
// WithNamespaceID adds the namespaceID to the waypoint list pipelines params
func (o *WaypointListPipelinesParams) WithNamespaceID(namespaceID string) *WaypointListPipelinesParams {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint list pipelines params
func (o *WaypointListPipelinesParams) SetNamespaceID(namespaceID string) {
