...
// Code gets the status code for the waypoint generate login token o k response
func (o *WaypointGenerateLoginTokenOK) Code() int {
	return 200
}
...
func (o *WaypointGenerateLoginTokenDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
