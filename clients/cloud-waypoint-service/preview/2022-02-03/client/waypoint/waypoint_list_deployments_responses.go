...
// Code gets the status code for the waypoint list deployments o k response
func (o *WaypointListDeploymentsOK) Code() int {
	return 200
}
...
func (o *WaypointListDeploymentsDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
