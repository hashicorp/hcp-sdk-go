...
// Code gets the status code for the waypoint list on demand runner configs o k response
func (o *WaypointListOnDemandRunnerConfigsOK) Code() int {
	return 200
}
...
func (o *WaypointListOnDemandRunnerConfigsDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
