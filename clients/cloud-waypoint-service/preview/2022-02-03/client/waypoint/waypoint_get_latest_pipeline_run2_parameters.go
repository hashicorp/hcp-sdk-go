...
// WithNamespaceID adds the namespaceID to the waypoint get latest pipeline run2 params
func (o *WaypointGetLatestPipelineRun2Params) WithNamespaceID(namespaceID string) *WaypointGetLatestPipelineRun2Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get latest pipeline run2 params
func (o *WaypointGetLatestPipelineRun2Params) SetNamespaceID(namespaceID string) {
