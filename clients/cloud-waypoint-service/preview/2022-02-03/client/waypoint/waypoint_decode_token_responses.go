...
// Code gets the status code for the waypoint decode token o k response
func (o *WaypointDecodeTokenOK) Code() int {
	return 200
}
...
func (o *WaypointDecodeTokenDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
