...
// Code gets the status code for the waypoint upsert application o k response
func (o *WaypointUpsertApplicationOK) Code() int {
	return 200
}
...
func (o *WaypointUpsertApplicationDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
