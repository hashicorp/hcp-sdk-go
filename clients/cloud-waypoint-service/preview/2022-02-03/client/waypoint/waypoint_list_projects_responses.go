...
// Code gets the status code for the waypoint list projects o k response
func (o *WaypointListProjectsOK) Code() int {
	return 200
}
...
func (o *WaypointListProjectsDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
