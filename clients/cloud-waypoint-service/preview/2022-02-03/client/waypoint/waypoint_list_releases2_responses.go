...
// Code gets the status code for the waypoint list releases2 o k response
func (o *WaypointListReleases2OK) Code() int {
	return 200
}
...
func (o *WaypointListReleases2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
