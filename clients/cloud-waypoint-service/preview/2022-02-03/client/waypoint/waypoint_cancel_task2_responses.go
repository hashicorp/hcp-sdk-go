...
// Code gets the status code for the waypoint cancel task2 o k response
func (o *WaypointCancelTask2OK) Code() int {
	return 200
}
...
func (o *WaypointCancelTask2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
