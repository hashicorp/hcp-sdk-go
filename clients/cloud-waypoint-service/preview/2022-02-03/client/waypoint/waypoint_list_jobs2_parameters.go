...
// WithPipelineRootPipelineID adds the pipelineRootPipelineID to the waypoint list jobs2 params
func (o *WaypointListJobs2Params) WithPipelineRootPipelineID(pipelineRootPipelineID *string) *WaypointListJobs2Params {
	o.SetPipelineRootPipelineID(pipelineRootPipelineID)
	return o
}

// SetPipelineRootPipelineID adds the pipelineRootPipelineId to the waypoint list jobs2 params
func (o *WaypointListJobs2Params) SetPipelineRootPipelineID(pipelineRootPipelineID *string) {
	o.PipelineRootPipelineID = pipelineRootPipelineID
}

// WithPipelineRootPipelineName adds the pipelineRootPipelineName to the waypoint list jobs2 params
func (o *WaypointListJobs2Params) WithPipelineRootPipelineName(pipelineRootPipelineName *string) *WaypointListJobs2Params {
	o.SetPipelineRootPipelineName(pipelineRootPipelineName)
	return o
}

// SetPipelineRootPipelineName adds the pipelineRootPipelineName to the waypoint list jobs2 params
func (o *WaypointListJobs2Params) SetPipelineRootPipelineName(pipelineRootPipelineName *string) {
