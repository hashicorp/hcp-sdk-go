...
// Code gets the status code for the waypoint get latest pipeline run o k response
func (o *WaypointGetLatestPipelineRunOK) Code() int {
	return 200
}

func (o *WaypointGetLatestPipelineRunOK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/project/{pipeline.owner.project.project}/pipeline/{pipeline.owner.pipeline_name}/latest-run][%d] waypointGetLatestPipelineRunOK  %+v", 200, o.Payload)
}
...
func (o *WaypointGetLatestPipelineRunDefault) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/project/{pipeline.owner.project.project}/pipeline/{pipeline.owner.pipeline_name}/latest-run][%d] Waypoint_GetLatestPipelineRun default  %+v", o._statusCode, o.Payload)
}
...
func (o *WaypointGetLatestPipelineRunDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
