...
// Code gets the status code for the waypoint get version info o k response
func (o *WaypointGetVersionInfoOK) Code() int {
	return 200
}
...
func (o *WaypointGetVersionInfoDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
