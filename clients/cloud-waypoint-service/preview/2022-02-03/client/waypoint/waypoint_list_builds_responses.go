...
// Code gets the status code for the waypoint list builds o k response
func (o *WaypointListBuildsOK) Code() int {
	return 200
}
...
func (o *WaypointListBuildsDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
