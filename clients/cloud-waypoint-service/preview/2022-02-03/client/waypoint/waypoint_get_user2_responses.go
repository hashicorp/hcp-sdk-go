...
// Code gets the status code for the waypoint get user2 o k response
func (o *WaypointGetUser2OK) Code() int {
	return 200
}
...
func (o *WaypointGetUser2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
