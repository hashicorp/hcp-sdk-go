...
// Code gets the status code for the waypoint upsert project o k response
func (o *WaypointUpsertProjectOK) Code() int {
	return 200
}
...
func (o *WaypointUpsertProjectDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
