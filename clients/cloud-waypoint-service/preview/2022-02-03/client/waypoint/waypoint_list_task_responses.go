...
// Code gets the status code for the waypoint list task o k response
func (o *WaypointListTaskOK) Code() int {
	return 200
}
...
func (o *WaypointListTaskDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
