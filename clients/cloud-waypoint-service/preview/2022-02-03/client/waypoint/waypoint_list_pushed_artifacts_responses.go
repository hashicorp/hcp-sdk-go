...
// Code gets the status code for the waypoint list pushed artifacts o k response
func (o *WaypointListPushedArtifactsOK) Code() int {
	return 200
}
...
func (o *WaypointListPushedArtifactsDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
