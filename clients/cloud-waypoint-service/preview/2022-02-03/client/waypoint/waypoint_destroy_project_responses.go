...
// Code gets the status code for the waypoint destroy project o k response
func (o *WaypointDestroyProjectOK) Code() int {
	return 200
}
...
func (o *WaypointDestroyProjectDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
