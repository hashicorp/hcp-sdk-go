...
// WithPipelineRootPipelineID adds the pipelineRootPipelineID to the waypoint list jobs3 params
func (o *WaypointListJobs3Params) WithPipelineRootPipelineID(pipelineRootPipelineID *string) *WaypointListJobs3Params {
	o.SetPipelineRootPipelineID(pipelineRootPipelineID)
	return o
}

// SetPipelineRootPipelineID adds the pipelineRootPipelineId to the waypoint list jobs3 params
func (o *WaypointListJobs3Params) SetPipelineRootPipelineID(pipelineRootPipelineID *string) {
	o.PipelineRootPipelineID = pipelineRootPipelineID
}

// WithPipelineRootPipelineName adds the pipelineRootPipelineName to the waypoint list jobs3 params
func (o *WaypointListJobs3Params) WithPipelineRootPipelineName(pipelineRootPipelineName *string) *WaypointListJobs3Params {
	o.SetPipelineRootPipelineName(pipelineRootPipelineName)
	return o
}

// SetPipelineRootPipelineName adds the pipelineRootPipelineName to the waypoint list jobs3 params
func (o *WaypointListJobs3Params) SetPipelineRootPipelineName(pipelineRootPipelineName *string) {
