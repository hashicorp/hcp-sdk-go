...
// Code gets the status code for the waypoint run pipeline o k response
func (o *WaypointRunPipelineOK) Code() int {
	return 200
}

func (o *WaypointRunPipelineOK) Error() string {
	return fmt.Sprintf("[POST /waypoint/2022-02-03/namespace/{namespace_id}/project/{pipeline.owner.project.project}/pipeline/{pipeline.owner.pipeline_name}/run][%d] waypointRunPipelineOK  %+v", 200, o.Payload)
}
...
func (o *WaypointRunPipelineDefault) Error() string {
	return fmt.Sprintf("[POST /waypoint/2022-02-03/namespace/{namespace_id}/project/{pipeline.owner.project.project}/pipeline/{pipeline.owner.pipeline_name}/run][%d] Waypoint_RunPipeline default  %+v", o._statusCode, o.Payload)
}
...
func (o *WaypointRunPipelineDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
