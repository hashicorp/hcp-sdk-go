...
// Code gets the status code for the waypoint get build2 o k response
func (o *WaypointGetBuild2OK) Code() int {
	return 200
}
...
func (o *WaypointGetBuild2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
