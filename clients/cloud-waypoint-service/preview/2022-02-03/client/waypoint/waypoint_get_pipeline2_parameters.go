...
// WithNamespaceID adds the namespaceID to the waypoint get pipeline2 params
func (o *WaypointGetPipeline2Params) WithNamespaceID(namespaceID string) *WaypointGetPipeline2Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint get pipeline2 params
func (o *WaypointGetPipeline2Params) SetNamespaceID(namespaceID string) {
