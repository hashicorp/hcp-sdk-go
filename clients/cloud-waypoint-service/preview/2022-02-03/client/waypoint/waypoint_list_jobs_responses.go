...
// Code gets the status code for the waypoint list jobs o k response
func (o *WaypointListJobsOK) Code() int {
	return 200
}
...
func (o *WaypointListJobsDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
