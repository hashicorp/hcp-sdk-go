...
// Code gets the status code for the waypoint get release2 o k response
func (o *WaypointGetRelease2OK) Code() int {
	return 200
}
...
func (o *WaypointGetRelease2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
