...
// Code gets the status code for the waypoint get user o k response
func (o *WaypointGetUserOK) Code() int {
	return 200
}
...
func (o *WaypointGetUserDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
