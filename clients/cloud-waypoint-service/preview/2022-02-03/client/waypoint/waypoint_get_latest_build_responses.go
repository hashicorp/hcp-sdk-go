...
// Code gets the status code for the waypoint get latest build o k response
func (o *WaypointGetLatestBuildOK) Code() int {
	return 200
}
...
func (o *WaypointGetLatestBuildDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
