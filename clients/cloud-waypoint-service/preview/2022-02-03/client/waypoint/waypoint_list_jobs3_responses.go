...
// Code gets the status code for the waypoint list jobs3 o k response
func (o *WaypointListJobs3OK) Code() int {
	return 200
}
...
func (o *WaypointListJobs3Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
