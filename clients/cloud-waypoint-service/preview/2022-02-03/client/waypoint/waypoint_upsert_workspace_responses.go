...
// Code gets the status code for the waypoint upsert workspace o k response
func (o *WaypointUpsertWorkspaceOK) Code() int {
	return 200
}
...
func (o *WaypointUpsertWorkspaceDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
