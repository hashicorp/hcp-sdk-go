...
// WithNamespaceID adds the namespaceID to the waypoint run pipeline2 params
func (o *WaypointRunPipeline2Params) WithNamespaceID(namespaceID string) *WaypointRunPipeline2Params {
	o.SetNamespaceID(namespaceID)
	return o
}

// SetNamespaceID adds the namespaceId to the waypoint run pipeline2 params
func (o *WaypointRunPipeline2Params) SetNamespaceID(namespaceID string) {
