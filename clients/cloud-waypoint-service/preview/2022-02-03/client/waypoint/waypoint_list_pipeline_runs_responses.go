...
// Code gets the status code for the waypoint list pipeline runs o k response
func (o *WaypointListPipelineRunsOK) Code() int {
	return 200
}

func (o *WaypointListPipelineRunsOK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/project/{pipeline.owner.project.project}/pipeline/{pipeline.owner.pipeline_name}/runs][%d] waypointListPipelineRunsOK  %+v", 200, o.Payload)
}
...
func (o *WaypointListPipelineRunsDefault) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/project/{pipeline.owner.project.project}/pipeline/{pipeline.owner.pipeline_name}/runs][%d] Waypoint_ListPipelineRuns default  %+v", o._statusCode, o.Payload)
}
...
func (o *WaypointListPipelineRunsDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
