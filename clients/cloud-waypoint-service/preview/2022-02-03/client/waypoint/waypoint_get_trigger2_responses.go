...
// Code gets the status code for the waypoint get trigger2 o k response
func (o *WaypointGetTrigger2OK) Code() int {
	return 200
}
...
func (o *WaypointGetTrigger2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
