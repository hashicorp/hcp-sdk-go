...
// Code gets the status code for the waypoint Ui list deployments o k response
func (o *WaypointUIListDeploymentsOK) Code() int {
	return 200
}

func (o *WaypointUIListDeploymentsOK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/ui/project/{application.project}/application/{application.application}/deployments][%d] waypointUiListDeploymentsOK  %+v", 200, o.Payload)
}
...
func (o *WaypointUIListDeploymentsDefault) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/{namespace_id}/ui/project/{application.project}/application/{application.application}/deployments][%d] Waypoint_UI_ListDeployments default  %+v", o._statusCode, o.Payload)
}
...
func (o *WaypointUIListDeploymentsDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
