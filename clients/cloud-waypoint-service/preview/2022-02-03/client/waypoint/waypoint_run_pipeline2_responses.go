...
// Code gets the status code for the waypoint run pipeline2 o k response
func (o *WaypointRunPipeline2OK) Code() int {
	return 200
}

func (o *WaypointRunPipeline2OK) Error() string {
	return fmt.Sprintf("[POST /waypoint/2022-02-03/namespace/{namespace_id}/pipeline/{pipeline.id}/run][%d] waypointRunPipeline2OK  %+v", 200, o.Payload)
}
...
func (o *WaypointRunPipeline2Default) Error() string {
	return fmt.Sprintf("[POST /waypoint/2022-02-03/namespace/{namespace_id}/pipeline/{pipeline.id}/run][%d] Waypoint_RunPipeline2 default  %+v", o._statusCode, o.Payload)
}
...
func (o *WaypointRunPipeline2Default) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}
