...
func (o *WorkflowLibraryGetFromLibrary2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewWorkflowLibraryGetFromLibrary2OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewWorkflowLibraryGetFromLibrary2Default(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewWorkflowLibraryGetFromLibrary2OK() *WorkflowLibraryGetFromLibrary2OK {
	return &WorkflowLibraryGetFromLibrary2OK{}
}
...
func (o *WorkflowLibraryGetFromLibrary2OK) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/workflows/search/{name}][%d] workflowLibraryGetFromLibrary2OK  %+v", 200, o.Payload)
}
...
func (o *WorkflowLibraryGetFromLibrary2OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewWorkflowLibraryGetFromLibrary2Default(code int) *WorkflowLibraryGetFromLibrary2Default {
	return &WorkflowLibraryGetFromLibrary2Default{
		_statusCode: code,
	}
}
...
func (o *WorkflowLibraryGetFromLibrary2Default) Error() string {
	return fmt.Sprintf("[GET /waypoint/2022-02-03/namespace/workflows/search/{name}][%d] WorkflowLibrary_GetFromLibrary2 default  %+v", o._statusCode, o.Payload)
}
...
func (o *WorkflowLibraryGetFromLibrary2Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
