...
// HashicorpWaypointAddOnDefinition AddOnDefinition is the template for an add-on
//
// swagger:model hashicorp.waypoint.AddOnDefinition
type HashicorpWaypointAddOnDefinition struct {

	// Unique identifer of the Add-on definition
...
// Validate validates this hashicorp waypoint add on definition
func (m *HashicorpWaypointAddOnDefinition) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpWaypointAddOnDefinition) validateTerraformNocodeModule(formats strfmt.Registry) error {
...
// ContextValidate validate this hashicorp waypoint add on definition based on the context it is used
func (m *HashicorpWaypointAddOnDefinition) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpWaypointAddOnDefinition) contextValidateTerraformNocodeModule(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpWaypointAddOnDefinition) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HashicorpWaypointAddOnDefinition) UnmarshalBinary(b []byte) error {
	var res HashicorpWaypointAddOnDefinition
