...
func (m *HashicorpCloudWaypointUpdateTFCConfigResponse) validateTfcConfig(formats strfmt.Registry) error {
...
func (m *HashicorpCloudWaypointUpdateTFCConfigResponse) contextValidateTfcConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudWaypointUpdateTFCConfigResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudWaypointUpdateTFCConfigResponse
