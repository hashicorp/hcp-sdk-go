...
func (m *HashicorpCloudWebhookGetWebhookResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudWebhookGetWebhookResponse) validateWebhook(formats strfmt.Registry) error {
...
func (m *HashicorpCloudWebhookGetWebhookResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudWebhookGetWebhookResponse) contextValidateWebhook(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudWebhookGetWebhookResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudWebhookGetWebhookResponse
