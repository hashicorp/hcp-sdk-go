...
func (o *BoundaryServiceAvailableUpdateGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewBoundaryServiceAvailableUpdateGetOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewBoundaryServiceAvailableUpdateGetDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewBoundaryServiceAvailableUpdateGetOK() *BoundaryServiceAvailableUpdateGetOK {
	return &BoundaryServiceAvailableUpdateGetOK{}
}
...
func (o *BoundaryServiceAvailableUpdateGetOK) IsSuccess() bool {
	return true
}
...
func (o *BoundaryServiceAvailableUpdateGetOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the boundary service available update get o k response
func (o *BoundaryServiceAvailableUpdateGetOK) Code() int {
	return 200
}

func (o *BoundaryServiceAvailableUpdateGetOK) Error() string {
	return fmt.Sprintf("[GET /boundary/2021-12-21/organizations/{location.organization_id}/projects/{location.project_id}/clusters/{cluster_id}/update][%d] boundaryServiceAvailableUpdateGetOK  %+v", 200, o.Payload)
}

func (o *BoundaryServiceAvailableUpdateGetOK) String() string {
	return fmt.Sprintf("[GET /boundary/2021-12-21/organizations/{location.organization_id}/projects/{location.project_id}/clusters/{cluster_id}/update][%d] boundaryServiceAvailableUpdateGetOK  %+v", 200, o.Payload)
}

func (o *BoundaryServiceAvailableUpdateGetOK) GetPayload() *models.HashicorpCloudBoundary20211221AvailableUpdateGetResponse {
	return o.Payload
}

func (o *BoundaryServiceAvailableUpdateGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.HashicorpCloudBoundary20211221AvailableUpdateGetResponse)
...
func NewBoundaryServiceAvailableUpdateGetDefault(code int) *BoundaryServiceAvailableUpdateGetDefault {
	return &BoundaryServiceAvailableUpdateGetDefault{
		_statusCode: code,
	}
}
...
func (o *BoundaryServiceAvailableUpdateGetDefault) IsCode(code int) bool {
	return o._statusCode == code
}

// Code gets the status code for the boundary service available update get default response
func (o *BoundaryServiceAvailableUpdateGetDefault) Code() int {
	return o._statusCode
}

func (o *BoundaryServiceAvailableUpdateGetDefault) Error() string {
	return fmt.Sprintf("[GET /boundary/2021-12-21/organizations/{location.organization_id}/projects/{location.project_id}/clusters/{cluster_id}/update][%d] BoundaryService_AvailableUpdateGet default  %+v", o._statusCode, o.Payload)
}

func (o *BoundaryServiceAvailableUpdateGetDefault) String() string {
	return fmt.Sprintf("[GET /boundary/2021-12-21/organizations/{location.organization_id}/projects/{location.project_id}/clusters/{cluster_id}/update][%d] BoundaryService_AvailableUpdateGet default  %+v", o._statusCode, o.Payload)
}

func (o *BoundaryServiceAvailableUpdateGetDefault) GetPayload() *cloud.GrpcGatewayRuntimeError {
	return o.Payload
}

func (o *BoundaryServiceAvailableUpdateGetDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
