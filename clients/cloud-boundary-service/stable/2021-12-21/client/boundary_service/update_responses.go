...
func (o *UpdateOK) Error() string {
	return fmt.Sprintf("[POST /boundary/2021-12-21/organizations/{location.organization_id}/projects/{location.project_id}/clusters/{cluster_id}][%d] updateOK  %+v", 200, o.Payload)
}
...
func (o *UpdateDefault) Error() string {
	return fmt.Sprintf("[POST /boundary/2021-12-21/organizations/{location.organization_id}/projects/{location.project_id}/clusters/{cluster_id}][%d] Update default  %+v", o._statusCode, o.Payload)
}
