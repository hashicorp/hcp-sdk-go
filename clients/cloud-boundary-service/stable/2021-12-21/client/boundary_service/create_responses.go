...
func (o *CreateOK) Error() string {
	return fmt.Sprintf("[POST /boundary/2021-12-21/organizations/{location.organization_id}/projects/{location.project_id}/clusters][%d] createOK  %+v", 200, o.Payload)
}
...
func (o *CreateDefault) Error() string {
	return fmt.Sprintf("[POST /boundary/2021-12-21/organizations/{location.organization_id}/projects/{location.project_id}/clusters][%d] Create default  %+v", o._statusCode, o.Payload)
}
