...
func (o *GetCurrentUserPrincipalReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCurrentUserPrincipalOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewGetCurrentUserPrincipalDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetCurrentUserPrincipalOK() *GetCurrentUserPrincipalOK {
	return &GetCurrentUserPrincipalOK{}
}
...
func (o *GetCurrentUserPrincipalOK) Error() string {
	return fmt.Sprintf("[GET /iam/2019-12-10/me][%d] getCurrentUserPrincipalOK  %+v", 200, o.Payload)
}
...
func (o *GetCurrentUserPrincipalOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetCurrentUserPrincipalDefault(code int) *GetCurrentUserPrincipalDefault {
	return &GetCurrentUserPrincipalDefault{
		_statusCode: code,
	}
}
...
func (o *GetCurrentUserPrincipalDefault) Error() string {
	return fmt.Sprintf("[GET /iam/2019-12-10/me][%d] GetCurrentUserPrincipal default  %+v", o._statusCode, o.Payload)
}
...
func (o *GetCurrentUserPrincipalDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
