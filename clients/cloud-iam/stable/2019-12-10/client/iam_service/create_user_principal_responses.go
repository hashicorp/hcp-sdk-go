...
func (o *CreateUserPrincipalReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCreateUserPrincipalOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewCreateUserPrincipalDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *CreateUserPrincipalOK) Error() string {
	return fmt.Sprintf("[POST /iam/2019-12-10/user-principals][%d] createUserPrincipalOK  %+v", 200, o.Payload)
}
...
func (o *CreateUserPrincipalOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewCreateUserPrincipalDefault(code int) *CreateUserPrincipalDefault {
	return &CreateUserPrincipalDefault{
		_statusCode: code,
	}
}
...
func (o *CreateUserPrincipalDefault) Error() string {
	return fmt.Sprintf("[POST /iam/2019-12-10/user-principals][%d] CreateUserPrincipal default  %+v", o._statusCode, o.Payload)
}
...
func (o *CreateUserPrincipalDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
