...
// bindParamListGroups binds the parameter filter.group_resource_ids
func (o *ListGroupsParams) bindParamFilterGroupResourceIds(formats strfmt.Registry) []string {
