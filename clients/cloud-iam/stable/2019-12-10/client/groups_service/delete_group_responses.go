...
func (o *DeleteGroupOK) Error() string {
	return fmt.Sprintf("[DELETE /iam/2019-12-10/{resource_name}][%d] deleteGroupOK  %+v", 200, o.Payload)
}
...
func (o *DeleteGroupDefault) Error() string {
	return fmt.Sprintf("[DELETE /iam/2019-12-10/{resource_name}][%d] DeleteGroup default  %+v", o._statusCode, o.Payload)
}
