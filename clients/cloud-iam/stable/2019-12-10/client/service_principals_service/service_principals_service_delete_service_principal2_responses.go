...
func (o *ServicePrincipalsServiceDeleteServicePrincipal2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewServicePrincipalsServiceDeleteServicePrincipal2OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewServicePrincipalsServiceDeleteServicePrincipal2Default(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewServicePrincipalsServiceDeleteServicePrincipal2OK() *ServicePrincipalsServiceDeleteServicePrincipal2OK {
	return &ServicePrincipalsServiceDeleteServicePrincipal2OK{}
}
...
func (o *ServicePrincipalsServiceDeleteServicePrincipal2OK) IsSuccess() bool {
	return true
}
...
func (o *ServicePrincipalsServiceDeleteServicePrincipal2OK) IsRedirect() bool {
	return false
}
...
func (o *ServicePrincipalsServiceDeleteServicePrincipal2OK) IsClientError() bool {
	return false
}
...
func (o *ServicePrincipalsServiceDeleteServicePrincipal2OK) IsServerError() bool {
	return false
}
...
func (o *ServicePrincipalsServiceDeleteServicePrincipal2OK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the service principals service delete service principal2 o k response
func (o *ServicePrincipalsServiceDeleteServicePrincipal2OK) Code() int {
	return 200
}
...
func (o *ServicePrincipalsServiceDeleteServicePrincipal2OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewServicePrincipalsServiceDeleteServicePrincipal2Default(code int) *ServicePrincipalsServiceDeleteServicePrincipal2Default {
	return &ServicePrincipalsServiceDeleteServicePrincipal2Default{
		_statusCode: code,
	}
}
...
func (o *ServicePrincipalsServiceDeleteServicePrincipal2Default) IsSuccess() bool {
...
func (o *ServicePrincipalsServiceDeleteServicePrincipal2Default) IsRedirect() bool {
...
func (o *ServicePrincipalsServiceDeleteServicePrincipal2Default) IsClientError() bool {
...
func (o *ServicePrincipalsServiceDeleteServicePrincipal2Default) IsServerError() bool {
...
func (o *ServicePrincipalsServiceDeleteServicePrincipal2Default) IsCode(code int) bool {
	return o._statusCode == code
}

// Code gets the status code for the service principals service delete service principal2 default response
func (o *ServicePrincipalsServiceDeleteServicePrincipal2Default) Code() int {
...
func (o *ServicePrincipalsServiceDeleteServicePrincipal2Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
