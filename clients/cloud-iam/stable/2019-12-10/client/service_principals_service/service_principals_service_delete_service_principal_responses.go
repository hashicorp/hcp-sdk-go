...
func (o *ServicePrincipalsServiceDeleteServicePrincipalReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewServicePrincipalsServiceDeleteServicePrincipalOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewServicePrincipalsServiceDeleteServicePrincipalDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewServicePrincipalsServiceDeleteServicePrincipalOK() *ServicePrincipalsServiceDeleteServicePrincipalOK {
	return &ServicePrincipalsServiceDeleteServicePrincipalOK{}
}
...
func (o *ServicePrincipalsServiceDeleteServicePrincipalOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this service principals service delete service principal o k response has a 3xx status code
func (o *ServicePrincipalsServiceDeleteServicePrincipalOK) IsRedirect() bool {
	return false
}
...
func (o *ServicePrincipalsServiceDeleteServicePrincipalOK) IsClientError() bool {
	return false
}
...
func (o *ServicePrincipalsServiceDeleteServicePrincipalOK) IsServerError() bool {
	return false
}
...
func (o *ServicePrincipalsServiceDeleteServicePrincipalOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the service principals service delete service principal o k response
func (o *ServicePrincipalsServiceDeleteServicePrincipalOK) Code() int {
	return 200
}

func (o *ServicePrincipalsServiceDeleteServicePrincipalOK) Error() string {
	return fmt.Sprintf("[DELETE /2019-12-10/{resource_name}][%d] servicePrincipalsServiceDeleteServicePrincipalOK  %+v", 200, o.Payload)
}

func (o *ServicePrincipalsServiceDeleteServicePrincipalOK) String() string {
	return fmt.Sprintf("[DELETE /2019-12-10/{resource_name}][%d] servicePrincipalsServiceDeleteServicePrincipalOK  %+v", 200, o.Payload)
}

func (o *ServicePrincipalsServiceDeleteServicePrincipalOK) GetPayload() models.HashicorpCloudIamDeleteServicePrincipalResponse {
	return o.Payload
}

func (o *ServicePrincipalsServiceDeleteServicePrincipalOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewServicePrincipalsServiceDeleteServicePrincipalDefault(code int) *ServicePrincipalsServiceDeleteServicePrincipalDefault {
	return &ServicePrincipalsServiceDeleteServicePrincipalDefault{
		_statusCode: code,
	}
}
...
func (o *ServicePrincipalsServiceDeleteServicePrincipalDefault) IsSuccess() bool {
...
func (o *ServicePrincipalsServiceDeleteServicePrincipalDefault) IsRedirect() bool {
...
func (o *ServicePrincipalsServiceDeleteServicePrincipalDefault) IsClientError() bool {
...
func (o *ServicePrincipalsServiceDeleteServicePrincipalDefault) IsServerError() bool {
...
func (o *ServicePrincipalsServiceDeleteServicePrincipalDefault) IsCode(code int) bool {
	return o._statusCode == code
}

// Code gets the status code for the service principals service delete service principal default response
func (o *ServicePrincipalsServiceDeleteServicePrincipalDefault) Code() int {
	return o._statusCode
}

func (o *ServicePrincipalsServiceDeleteServicePrincipalDefault) Error() string {
	return fmt.Sprintf("[DELETE /2019-12-10/{resource_name}][%d] ServicePrincipalsService_DeleteServicePrincipal default  %+v", o._statusCode, o.Payload)
}

func (o *ServicePrincipalsServiceDeleteServicePrincipalDefault) String() string {
	return fmt.Sprintf("[DELETE /2019-12-10/{resource_name}][%d] ServicePrincipalsService_DeleteServicePrincipal default  %+v", o._statusCode, o.Payload)
}

func (o *ServicePrincipalsServiceDeleteServicePrincipalDefault) GetPayload() *cloud.GoogleRPCStatus {
	return o.Payload
}

func (o *ServicePrincipalsServiceDeleteServicePrincipalDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
