...
import (
	...
	"github.com/hashicorp/cloud-sdk-go/clients/cloud-resource-manager/preview/2019-12-10/client/resource_service"
)

// Default cloud resource manager HTTP client.
...
// NewHTTPClient creates a new cloud resource manager HTTP client.
func NewHTTPClient(formats strfmt.Registry) *CloudResourceManager {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new cloud resource manager HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *CloudResourceManager {
...
// New creates a new cloud resource manager client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *CloudResourceManager {
	// ensure nullable parameters have default
	if formats == nil {
