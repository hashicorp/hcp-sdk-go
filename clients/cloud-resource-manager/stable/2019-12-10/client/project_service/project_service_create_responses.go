...
type ProjectServiceCreateOK struct {
	Payload *models.ResourcemanagerProjectCreateResponse
}
...
func (o *ProjectServiceCreateOK) GetPayload() *models.ResourcemanagerProjectCreateResponse {
	return o.Payload
}
...
func (o *ProjectServiceCreateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ResourcemanagerProjectCreateResponse)
...
func (o *ProjectServiceCreateDefault) GetPayload() *models.RPCStatus {
	return o.Payload
}
