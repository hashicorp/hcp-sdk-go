...
type ResourceServiceListOK struct {
	Payload *models.ResourcemanagerResourceListResponse
}
...
func (o *ResourceServiceListOK) GetPayload() *models.ResourcemanagerResourceListResponse {
	return o.Payload
}
...
func (o *ResourceServiceListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ResourcemanagerResourceListResponse)
...
func (o *ResourceServiceListDefault) GetPayload() *models.RPCStatus {
	return o.Payload
}
