...
func (m *ResourcemanagerResourceListResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResourcemanagerResourceListResponse) validatePagination(formats strfmt.Registry) error {
...
func (m *ResourcemanagerResourceListResponse) validateResources(formats strfmt.Registry) error {
...
func (m *ResourcemanagerResourceListResponse) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResourcemanagerResourceListResponse) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResourcemanagerResourceListResponse) UnmarshalBinary(b []byte) error {
	var res ResourcemanagerResourceListResponse
