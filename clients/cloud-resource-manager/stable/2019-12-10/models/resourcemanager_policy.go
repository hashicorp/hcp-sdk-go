...
// ResourcemanagerPolicy Policy binds many instances of roles to member lists in the resource hierarchy.
// For example:
//
...
func (m *ResourcemanagerPolicy) validateBindings(formats strfmt.Registry) error {
...
func (m *ResourcemanagerPolicy) contextValidateBindings(ctx context.Context, formats strfmt.Registry) error {
