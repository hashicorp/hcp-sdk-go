...
func (m *LogService20210330ListStreamingDestinationsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LogService20210330ListStreamingDestinationsResponse) validateDestinations(formats strfmt.Registry) error {
...
func (m *LogService20210330ListStreamingDestinationsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *LogService20210330ListStreamingDestinationsResponse) contextValidateDestinations(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LogService20210330ListStreamingDestinationsResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *LogService20210330ListStreamingDestinationsResponse) UnmarshalBinary(b []byte) error {
	var res LogService20210330ListStreamingDestinationsResponse
