...
func (m *LogService20210330ListStreamingDestinationsForResourceResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LogService20210330ListStreamingDestinationsForResourceResponse) validateDestinations(formats strfmt.Registry) error {
...
func (m *LogService20210330ListStreamingDestinationsForResourceResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *LogService20210330ListStreamingDestinationsForResourceResponse) contextValidateDestinations(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LogService20210330ListStreamingDestinationsForResourceResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *LogService20210330ListStreamingDestinationsForResourceResponse) UnmarshalBinary(b []byte) error {
	var res LogService20210330ListStreamingDestinationsForResourceResponse
