...
func (o *LogServiceCreateStreamingDestination2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewLogServiceCreateStreamingDestination2OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewLogServiceCreateStreamingDestination2Default(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewLogServiceCreateStreamingDestination2OK() *LogServiceCreateStreamingDestination2OK {
	return &LogServiceCreateStreamingDestination2OK{}
}
...
func (o *LogServiceCreateStreamingDestination2OK) Error() string {
	return fmt.Sprintf("[POST /logs/2021-03-30/organizations/{location.organization_id}/resources/destinations][%d] logServiceCreateStreamingDestination2OK  %+v", 200, o.Payload)
}
...
func (o *LogServiceCreateStreamingDestination2OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewLogServiceCreateStreamingDestination2Default(code int) *LogServiceCreateStreamingDestination2Default {
	return &LogServiceCreateStreamingDestination2Default{
		_statusCode: code,
	}
}
...
*/
type LogServiceCreateStreamingDestination2Default struct {
	_statusCode int
...
func (o *LogServiceCreateStreamingDestination2Default) Error() string {
	return fmt.Sprintf("[POST /logs/2021-03-30/organizations/{location.organization_id}/resources/destinations][%d] LogService_CreateStreamingDestination2 default  %+v", o._statusCode, o.Payload)
}
...
func (o *LogServiceCreateStreamingDestination2Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
