...
func (o *LogServiceDeleteStreamingDestinationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewLogServiceDeleteStreamingDestinationOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewLogServiceDeleteStreamingDestinationDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewLogServiceDeleteStreamingDestinationOK() *LogServiceDeleteStreamingDestinationOK {
	return &LogServiceDeleteStreamingDestinationOK{}
}
...
func (o *LogServiceDeleteStreamingDestinationOK) Error() string {
	return fmt.Sprintf("[DELETE /logs/2021-03-30/organizations/{location.organization_id}/projects/{location.project_id}/resources/destinations/{destination_id}][%d] logServiceDeleteStreamingDestinationOK  %+v", 200, o.Payload)
}
...
func (o *LogServiceDeleteStreamingDestinationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.LogService20210330DeleteStreamingDestinationResponse)
...
func NewLogServiceDeleteStreamingDestinationDefault(code int) *LogServiceDeleteStreamingDestinationDefault {
	return &LogServiceDeleteStreamingDestinationDefault{
		_statusCode: code,
	}
}
...
*/
type LogServiceDeleteStreamingDestinationDefault struct {
	_statusCode int
...
func (o *LogServiceDeleteStreamingDestinationDefault) Error() string {
	return fmt.Sprintf("[DELETE /logs/2021-03-30/organizations/{location.organization_id}/projects/{location.project_id}/resources/destinations/{destination_id}][%d] LogService_DeleteStreamingDestination default  %+v", o._statusCode, o.Payload)
}
...
func (o *LogServiceDeleteStreamingDestinationDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
