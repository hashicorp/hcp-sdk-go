...
func (m *HashicorpCloudOperationWaitResponse) validateOperation(formats strfmt.Registry) error {
...
func (m *HashicorpCloudOperationWaitResponse) contextValidateOperation(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudOperationWaitResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudOperationWaitResponse
