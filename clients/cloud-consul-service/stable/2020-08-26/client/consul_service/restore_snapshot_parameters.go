...
func (o *RestoreSnapshotParams) WithBody(body *models.HashicorpCloudConsul20200826RestoreSnapshotRequest) *RestoreSnapshotParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the restore snapshot params
func (o *RestoreSnapshotParams) SetBody(body *models.HashicorpCloudConsul20200826RestoreSnapshotRequest) {
	o.Body = body
}
