...
func (o *GetSnapshotDefault) Error() string {
	return fmt.Sprintf("[GET /consul/2020-08-26/organizations/{location.organization_id}/projects/{location.project_id}/snapshots/{snapshot_id}][%d] GetSnapshot default  %+v", o._statusCode, o.Payload)
}

func (o *GetSnapshotDefault) GetPayload() *models.GrpcGatewayRuntimeError {
	return o.Payload
}
