...
func (m *HashicorpCloudConsul20200826SnapshotSnapshotMeta) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudConsul20200826SnapshotSnapshotMeta) validateRestoredAt(formats strfmt.Registry) error {
...
func (m *HashicorpCloudConsul20200826SnapshotSnapshotMeta) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *HashicorpCloudConsul20200826SnapshotSnapshotMeta) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HashicorpCloudConsul20200826SnapshotSnapshotMeta) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudConsul20200826SnapshotSnapshotMeta
