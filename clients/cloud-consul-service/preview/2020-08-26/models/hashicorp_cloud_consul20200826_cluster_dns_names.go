...
func (m *HashicorpCloudConsul20200826ClusterDNSNames) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this hashicorp cloud consul 20200826 cluster DNS names based on context it is used
func (m *HashicorpCloudConsul20200826ClusterDNSNames) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
...
func (m *HashicorpCloudConsul20200826ClusterDNSNames) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudConsul20200826ClusterDNSNames
