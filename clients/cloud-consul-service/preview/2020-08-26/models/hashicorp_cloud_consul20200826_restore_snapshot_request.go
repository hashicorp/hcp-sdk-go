...
func (m *HashicorpCloudConsul20200826RestoreSnapshotRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudConsul20200826RestoreSnapshotRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HashicorpCloudConsul20200826RestoreSnapshotRequest) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudConsul20200826RestoreSnapshotRequest
