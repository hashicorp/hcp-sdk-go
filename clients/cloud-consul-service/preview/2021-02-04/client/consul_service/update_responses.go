...
func (o *UpdateOK) Error() string {
	return fmt.Sprintf("[PATCH /consul/2021-02-04/organizations/{cluster.location.organization_id}/projects/{cluster.location.project_id}/clusters/{cluster.id}][%d] updateOK  %+v", 200, o.Payload)
}
...
func (o *UpdateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.HashicorpCloudConsul20210204UpdateResponse)
...
func (o *UpdateDefault) Error() string {
	return fmt.Sprintf("[PATCH /consul/2021-02-04/organizations/{cluster.location.organization_id}/projects/{cluster.location.project_id}/clusters/{cluster.id}][%d] Update default  %+v", o._statusCode, o.Payload)
}

func (o *UpdateDefault) GetPayload() *models.GrpcGatewayRuntimeError {
	return o.Payload
}
