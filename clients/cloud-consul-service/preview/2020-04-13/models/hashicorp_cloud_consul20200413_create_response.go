...
// ContextValidate validate this hashicorp cloud consul 20200413 create response based on the context it is used
func (m *HashicorpCloudConsul20200413CreateResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudConsul20200413CreateResponse) contextValidateOperation(ctx context.Context, formats strfmt.Registry) error {
