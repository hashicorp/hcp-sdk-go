...
// ContextValidate validate this hashicorp cloud consul 20200413 create request based on the context it is used
func (m *HashicorpCloudConsul20200413CreateRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudConsul20200413CreateRequest) contextValidateCluster(ctx context.Context, formats strfmt.Registry) error {
