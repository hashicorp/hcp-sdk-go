...
func NewHashicorpCloudConsul20200413ClusterState(value HashicorpCloudConsul20200413ClusterState) *HashicorpCloudConsul20200413ClusterState {
	v := value
	return &v
}
...
// ContextValidate validates this hashicorp cloud consul 20200413 cluster state based on context it is used
func (m HashicorpCloudConsul20200413ClusterState) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
