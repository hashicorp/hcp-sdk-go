...
// ContextValidate validates this hashicorp cloud consul 20200413 cluster DNS names based on context it is used
func (m *HashicorpCloudConsul20200413ClusterDNSNames) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
