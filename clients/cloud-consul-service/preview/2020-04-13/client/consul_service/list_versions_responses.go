...
type ListVersionsOK struct {
	Payload *models.HashicorpCloudConsul20200413ListVersionsResponse
}

func (o *ListVersionsOK) Error() string {
	return fmt.Sprintf("[GET /consul/2020-04-13/versions][%d] listVersionsOK  %+v", 200, o.Payload)
}

func (o *ListVersionsOK) GetPayload() *models.HashicorpCloudConsul20200413ListVersionsResponse {
	return o.Payload
}
...
func (o *ListVersionsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.HashicorpCloudConsul20200413ListVersionsResponse)
...
func (o *ListVersionsDefault) Error() string {
	return fmt.Sprintf("[GET /consul/2020-04-13/versions][%d] ListVersions default  %+v", o._statusCode, o.Payload)
}
