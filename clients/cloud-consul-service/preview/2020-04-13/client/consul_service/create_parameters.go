...
type CreateParams struct {
	...
	/*Body*/
	Body *models.HashicorpCloudConsul20200413CreateRequest
...
func (o *CreateParams) WithBody(body *models.HashicorpCloudConsul20200413CreateRequest) *CreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create params
func (o *CreateParams) SetBody(body *models.HashicorpCloudConsul20200413CreateRequest) {
	o.Body = body
}
