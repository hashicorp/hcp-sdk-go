...
type ListUpgradeVersionsOK struct {
	Payload *models.HashicorpCloudConsul20200413ListUpgradeVersionsResponse
}

func (o *ListUpgradeVersionsOK) Error() string {
	return fmt.Sprintf("[GET /consul/2020-04-13/organizations/{location.organization_id}/projects/{location.project_id}/clusters/{id}/upgrade-versions][%d] listUpgradeVersionsOK  %+v", 200, o.Payload)
}
func (o *ListUpgradeVersionsOK) GetPayload() *models.HashicorpCloudConsul20200413ListUpgradeVersionsResponse {
	return o.Payload
}
...
func (o *ListUpgradeVersionsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.HashicorpCloudConsul20200413ListUpgradeVersionsResponse)
...
func (o *ListUpgradeVersionsDefault) Error() string {
	return fmt.Sprintf("[GET /consul/2020-04-13/organizations/{location.organization_id}/projects/{location.project_id}/clusters/{id}/upgrade-versions][%d] ListUpgradeVersions default  %+v", o._statusCode, o.Payload)
}
