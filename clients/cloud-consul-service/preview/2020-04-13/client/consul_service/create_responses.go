...
type CreateOK struct {
	Payload *models.HashicorpCloudConsul20200413CreateResponse
}

func (o *CreateOK) Error() string {
	return fmt.Sprintf("[POST /consul/2020-04-13/organizations/{cluster.location.organization_id}/projects/{cluster.location.project_id}/clusters][%d] createOK  %+v", 200, o.Payload)
}
func (o *CreateOK) GetPayload() *models.HashicorpCloudConsul20200413CreateResponse {
	return o.Payload
}

func (o *CreateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.HashicorpCloudConsul20200413CreateResponse)
...
func (o *CreateDefault) Error() string {
	return fmt.Sprintf("[POST /consul/2020-04-13/organizations/{cluster.location.organization_id}/projects/{cluster.location.project_id}/clusters][%d] Create default  %+v", o._statusCode, o.Payload)
}
