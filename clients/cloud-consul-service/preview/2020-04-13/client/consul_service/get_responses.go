...
*/
type GetOK struct {
	Payload *models.HashicorpCloudConsul20200413GetResponse
}

func (o *GetOK) Error() string {
	return fmt.Sprintf("[GET /consul/2020-04-13/organizations/{location.organization_id}/projects/{location.project_id}/clusters/{id}][%d] getOK  %+v", 200, o.Payload)
}

func (o *GetOK) GetPayload() *models.HashicorpCloudConsul20200413GetResponse {
	return o.Payload
}

func (o *GetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.HashicorpCloudConsul20200413GetResponse)
...
func (o *GetDefault) Error() string {
	return fmt.Sprintf("[GET /consul/2020-04-13/organizations/{location.organization_id}/projects/{location.project_id}/clusters/{id}][%d] Get default  %+v", o._statusCode, o.Payload)
}
