...
type GetClientConfigOK struct {
	Payload *models.HashicorpCloudConsul20200413GetClientConfigResponse
}

func (o *GetClientConfigOK) Error() string {
	return fmt.Sprintf("[GET /consul/2020-04-13/organizations/{location.organization_id}/projects/{location.project_id}/clusters/{id}/client-config][%d] getClientConfigOK  %+v", 200, o.Payload)
}
func (o *GetClientConfigOK) GetPayload() *models.HashicorpCloudConsul20200413GetClientConfigResponse {
	return o.Payload
}
...
func (o *GetClientConfigOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.HashicorpCloudConsul20200413GetClientConfigResponse)
...
func (o *GetClientConfigDefault) Error() string {
	return fmt.Sprintf("[GET /consul/2020-04-13/organizations/{location.organization_id}/projects/{location.project_id}/clusters/{id}/client-config][%d] GetClientConfig default  %+v", o._statusCode, o.Payload)
}
