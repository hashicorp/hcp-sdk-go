...
type DeleteOK struct {
	Payload *models.HashicorpCloudConsul20200413DeleteResponse
}

func (o *DeleteOK) Error() string {
	return fmt.Sprintf("[DELETE /consul/2020-04-13/organizations/{location.organization_id}/projects/{location.project_id}/clusters/{id}][%d] deleteOK  %+v", 200, o.Payload)
}

func (o *DeleteOK) GetPayload() *models.HashicorpCloudConsul20200413DeleteResponse {
	return o.Payload
}

func (o *DeleteOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.HashicorpCloudConsul20200413DeleteResponse)
...
func (o *DeleteDefault) Error() string {
	return fmt.Sprintf("[DELETE /consul/2020-04-13/organizations/{location.organization_id}/projects/{location.project_id}/clusters/{id}][%d] Delete default  %+v", o._statusCode, o.Payload)
}
