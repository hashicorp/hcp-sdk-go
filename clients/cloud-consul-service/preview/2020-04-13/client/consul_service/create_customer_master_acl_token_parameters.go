...
type CreateCustomerMasterACLTokenParams struct {
	...
	/*Body*/
	Body *models.HashicorpCloudConsul20200413CreateCustomerMasterACLTokenRequest
	/*ID
...
func (o *CreateCustomerMasterACLTokenParams) WithBody(body *models.HashicorpCloudConsul20200413CreateCustomerMasterACLTokenRequest) *CreateCustomerMasterACLTokenParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create customer master ACL token params
func (o *CreateCustomerMasterACLTokenParams) SetBody(body *models.HashicorpCloudConsul20200413CreateCustomerMasterACLTokenRequest) {
	o.Body = body
}
