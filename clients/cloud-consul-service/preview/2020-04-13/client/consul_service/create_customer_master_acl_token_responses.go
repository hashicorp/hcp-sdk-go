...
type CreateCustomerMasterACLTokenOK struct {
	Payload *models.HashicorpCloudConsul20200413CreateCustomerMasterACLTokenResponse
}

func (o *CreateCustomerMasterACLTokenOK) Error() string {
	return fmt.Sprintf("[POST /consul/2020-04-13/organizations/{location.organization_id}/projects/{location.project_id}/clusters/{id}/master-acl-tokens][%d] createCustomerMasterAclTokenOK  %+v", 200, o.Payload)
}
func (o *CreateCustomerMasterACLTokenOK) GetPayload() *models.HashicorpCloudConsul20200413CreateCustomerMasterACLTokenResponse {
	return o.Payload
}
...
func (o *CreateCustomerMasterACLTokenOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.HashicorpCloudConsul20200413CreateCustomerMasterACLTokenResponse)
...
func (o *CreateCustomerMasterACLTokenDefault) Error() string {
	return fmt.Sprintf("[POST /consul/2020-04-13/organizations/{location.organization_id}/projects/{location.project_id}/clusters/{id}/master-acl-tokens][%d] CreateCustomerMasterACLToken default  %+v", o._statusCode, o.Payload)
}
