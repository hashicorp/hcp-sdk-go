...
// New creates a new integration subscription service API client with basic auth credentials.
...
// New creates a new integration subscription service API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
