...
func (o *CompleteUploadBoxOK) Error() string {
	return fmt.Sprintf("[PUT /vagrant/2022-09-30/registry/{registry}/boxes/{box}/versions/{version}/providers/{provider}/architectures/{architecture}/complete][%d] completeUploadBoxOK  %+v", 200, o.Payload)
}
...
func (o *CompleteUploadBoxDefault) Error() string {
	return fmt.Sprintf("[PUT /vagrant/2022-09-30/registry/{registry}/boxes/{box}/versions/{version}/providers/{provider}/architectures/{architecture}/complete][%d] CompleteUploadBox default  %+v", o._statusCode, o.Payload)
}
