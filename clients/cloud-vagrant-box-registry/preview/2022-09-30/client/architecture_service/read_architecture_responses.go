...
func (o *ReadArchitectureOK) Error() string {
	return fmt.Sprintf("[GET /vagrant/2022-09-30/registry/{registry}/boxes/{box}/versions/{version}/providers/{provider}/architectures/{architecture}][%d] readArchitectureOK  %+v", 200, o.Payload)
}
...
func (o *ReadArchitectureDefault) Error() string {
	return fmt.Sprintf("[GET /vagrant/2022-09-30/registry/{registry}/boxes/{box}/versions/{version}/providers/{provider}/architectures/{architecture}][%d] ReadArchitecture default  %+v", o._statusCode, o.Payload)
}
