...
func (o *DeleteVersionOK) Error() string {
	return fmt.Sprintf("[DELETE /vagrant/2022-09-30/registry/{registry}/box/{box}/version/{version}][%d] deleteVersionOK  %+v", 200, o.Payload)
}
...
func (o *DeleteVersionDefault) Error() string {
	return fmt.Sprintf("[DELETE /vagrant/2022-09-30/registry/{registry}/box/{box}/version/{version}][%d] DeleteVersion default  %+v", o._statusCode, o.Payload)
}
