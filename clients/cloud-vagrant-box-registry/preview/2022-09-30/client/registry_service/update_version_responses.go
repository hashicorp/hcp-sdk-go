...
func (o *UpdateVersionOK) Error() string {
	return fmt.Sprintf("[PUT /vagrant/2022-09-30/registry/{registry}/box/{box}/version/{version}][%d] updateVersionOK  %+v", 200, o.Payload)
}
...
func (o *UpdateVersionDefault) Error() string {
	return fmt.Sprintf("[PUT /vagrant/2022-09-30/registry/{registry}/box/{box}/version/{version}][%d] UpdateVersion default  %+v", o._statusCode, o.Payload)
}
