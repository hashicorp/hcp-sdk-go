...
func (o *ListArchitecturesOK) Error() string {
	return fmt.Sprintf("[GET /vagrant/2022-09-30/registry/{registry}/box/{box}/version/{version}/provider/{provider}/architectures][%d] listArchitecturesOK  %+v", 200, o.Payload)
}
...
func (o *ListArchitecturesDefault) Error() string {
	return fmt.Sprintf("[GET /vagrant/2022-09-30/registry/{registry}/box/{box}/version/{version}/provider/{provider}/architectures][%d] ListArchitectures default  %+v", o._statusCode, o.Payload)
}
