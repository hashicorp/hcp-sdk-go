...
func (o *DeleteBoxOK) Error() string {
	return fmt.Sprintf("[DELETE /vagrant/2022-09-30/registry/{registry}/box/{box}][%d] deleteBoxOK  %+v", 200, o.Payload)
}
...
func (o *DeleteBoxDefault) Error() string {
	return fmt.Sprintf("[DELETE /vagrant/2022-09-30/registry/{registry}/box/{box}][%d] DeleteBox default  %+v", o._statusCode, o.Payload)
}
