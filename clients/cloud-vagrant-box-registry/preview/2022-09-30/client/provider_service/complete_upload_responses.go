...
/*CompleteUploadOK handles this case with default header values.

A successful response.
*/
type CompleteUploadOK struct {
	Payload models.HashicorpCloudVagrant20220930CompleteUploadResponse
}
...
func (o *CompleteUploadOK) GetPayload() models.HashicorpCloudVagrant20220930CompleteUploadResponse {
	return o.Payload
}

func (o *CompleteUploadOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
