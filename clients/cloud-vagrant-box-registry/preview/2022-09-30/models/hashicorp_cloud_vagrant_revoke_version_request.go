...
func (m *HashicorpCloudVagrantRevokeVersionRequest) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this hashicorp cloud vagrant revoke version request based on context it is used
func (m *HashicorpCloudVagrantRevokeVersionRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
...
func (m *HashicorpCloudVagrantRevokeVersionRequest) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudVagrantRevokeVersionRequest
