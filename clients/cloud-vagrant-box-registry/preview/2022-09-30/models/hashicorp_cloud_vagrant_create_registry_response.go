...
func (m *HashicorpCloudVagrantCreateRegistryResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudVagrantCreateRegistryResponse) contextValidateRegistry(ctx context.Context, formats strfmt.Registry) error {
