...
func (m *HashicorpCloudVagrantBox) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *HashicorpCloudVagrantBox) validateUpdatedAt(formats strfmt.Registry) error {
...
func (m *HashicorpCloudVagrantBox) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudVagrantBox
