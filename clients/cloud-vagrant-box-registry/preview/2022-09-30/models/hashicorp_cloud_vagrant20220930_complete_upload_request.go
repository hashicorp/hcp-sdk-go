...
type HashicorpCloudVagrant20220930CompleteUploadRequest struct {
...
// Validate validates this hashicorp cloud vagrant 20220930 complete upload request
func (m *HashicorpCloudVagrant20220930CompleteUploadRequest) Validate(formats strfmt.Registry) error {
	return nil
}
...
func (m *HashicorpCloudVagrant20220930CompleteUploadRequest) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudVagrant20220930CompleteUploadRequest
