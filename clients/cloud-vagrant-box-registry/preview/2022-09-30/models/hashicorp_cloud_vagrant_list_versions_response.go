...
func (m *HashicorpCloudVagrantListVersionsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudVagrantListVersionsResponse) validatePagination(formats strfmt.Registry) error {
...
func (m *HashicorpCloudVagrantListVersionsResponse) validateVersions(formats strfmt.Registry) error {
...
func (m *HashicorpCloudVagrantListVersionsResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudVagrantListVersionsResponse
