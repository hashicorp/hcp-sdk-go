...
func (m *HashicorpCloudVagrantVersion) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *HashicorpCloudVagrantVersion) validateState(formats strfmt.Registry) error {
...
func (m *HashicorpCloudVagrantVersion) validateUpdatedAt(formats strfmt.Registry) error {
...
func (m *HashicorpCloudVagrantVersion) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudVagrantVersion
