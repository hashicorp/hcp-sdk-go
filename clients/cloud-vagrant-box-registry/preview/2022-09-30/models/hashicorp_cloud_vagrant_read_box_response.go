...
func (m *HashicorpCloudVagrantReadBoxResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudVagrantReadBoxResponse) validateBox(formats strfmt.Registry) error {
...
func (m *HashicorpCloudVagrantReadBoxResponse) contextValidateBox(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudVagrantReadBoxResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudVagrantReadBoxResponse
