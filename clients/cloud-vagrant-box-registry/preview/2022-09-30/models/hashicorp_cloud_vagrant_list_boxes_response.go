...
func (m *HashicorpCloudVagrantListBoxesResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudVagrantListBoxesResponse) validateBoxes(formats strfmt.Registry) error {
...
func (m *HashicorpCloudVagrantListBoxesResponse) validatePagination(formats strfmt.Registry) error {
...
func (m *HashicorpCloudVagrantListBoxesResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudVagrantListBoxesResponse
