...
type HashicorpCloudVagrant20220930CreateProviderRequest struct {
...
// Validate validates this hashicorp cloud vagrant 20220930 create provider request
func (m *HashicorpCloudVagrant20220930CreateProviderRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudVagrant20220930CreateProviderRequest) validateExternal(formats strfmt.Registry) error {
...
func (m *HashicorpCloudVagrant20220930CreateProviderRequest) validateHosted(formats strfmt.Registry) error {
...
func (m *HashicorpCloudVagrant20220930CreateProviderRequest) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudVagrant20220930CreateProviderRequest
