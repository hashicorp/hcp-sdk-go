...
func (o *ListVersionsOK) Error() string {
	return fmt.Sprintf("[GET /vagrant/2022-09-30/registry/{registry}/box/{box}/versions][%d] listVersionsOK  %+v", 200, o.Payload)
}
...
func (o *ListVersionsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.HashicorpCloudVagrant20220930ListVersionsResponse)
...
func (o *ListVersionsDefault) Error() string {
	return fmt.Sprintf("[GET /vagrant/2022-09-30/registry/{registry}/box/{box}/versions][%d] ListVersions default  %+v", o._statusCode, o.Payload)
}
