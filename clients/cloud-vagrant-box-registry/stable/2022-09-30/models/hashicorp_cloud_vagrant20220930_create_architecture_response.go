...
func (m *HashicorpCloudVagrant20220930CreateArchitectureResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudVagrant20220930CreateArchitectureResponse) validateArchitecture(formats strfmt.Registry) error {
...
func (m *HashicorpCloudVagrant20220930CreateArchitectureResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudVagrant20220930CreateArchitectureResponse) contextValidateArchitecture(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudVagrant20220930CreateArchitectureResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HashicorpCloudVagrant20220930CreateArchitectureResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudVagrant20220930CreateArchitectureResponse
