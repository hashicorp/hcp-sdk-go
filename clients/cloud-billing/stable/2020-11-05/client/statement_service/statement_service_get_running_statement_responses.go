...
func (o *StatementServiceGetRunningStatementOK) Error() string {
	...
	return fmt.Sprintf("[GET /billing/2020-11-05/organizations/{organization_id}/accounts/{billing_account_id}/running-statement][%d] statementServiceGetRunningStatementOK %s", 200, payload)
}
...
func (o *StatementServiceGetRunningStatementDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /billing/2020-11-05/organizations/{organization_id}/accounts/{billing_account_id}/running-statement][%d] StatementService_GetRunningStatement default %s", o._statusCode, payload)
}
