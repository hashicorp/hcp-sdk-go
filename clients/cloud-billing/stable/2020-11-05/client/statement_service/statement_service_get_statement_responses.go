...
// Code gets the status code for the statement service get statement o k response
func (o *StatementServiceGetStatementOK) Code() int {
	return 200
}

func (o *StatementServiceGetStatementOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /billing/2020-11-05/organizations/{organization_id}/accounts/{billing_account_id}/statements/{statement_id}][%d] statementServiceGetStatementOK %s", 200, payload)
}
...
func (o *StatementServiceGetStatementDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /billing/2020-11-05/organizations/{organization_id}/accounts/{billing_account_id}/statements/{statement_id}][%d] StatementService_GetStatement default %s", o._statusCode, payload)
}
...
func (o *StatementServiceGetStatementDefault) GetPayload() *models.GooglerpcStatus {
	return o.Payload
}
