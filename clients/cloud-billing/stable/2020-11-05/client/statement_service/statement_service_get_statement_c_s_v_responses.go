...
func (o *StatementServiceGetStatementCSVOK) Error() string {
	...
	return fmt.Sprintf("[GET /billing/2020-11-05/organizations/{organization_id}/accounts/{billing_account_id}/statements/{statement_id}/csv][%d] statementServiceGetStatementCSVOK %s", 200, payload)
}
...
func (o *StatementServiceGetStatementCSVDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /billing/2020-11-05/organizations/{organization_id}/accounts/{billing_account_id}/statements/{statement_id}/csv][%d] StatementService_GetStatementCSV default %s", o._statusCode, payload)
}
