...
func (o *ContractServiceGetContractOK) Error() string {
	...
	return fmt.Sprintf("[GET /billing/2020-11-05/organizations/{organization_id}/accounts/{billing_account_id}/contracts/{contract_id}][%d] contractServiceGetContractOK %s", 200, payload)
}
...
func (o *ContractServiceGetContractDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /billing/2020-11-05/organizations/{organization_id}/accounts/{billing_account_id}/contracts/{contract_id}][%d] ContractService_GetContract default %s", o._statusCode, payload)
}
