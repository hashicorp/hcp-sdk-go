...
func (o *BillingAccountServiceGetByProjectOK) Error() string {
	...
	return fmt.Sprintf("[GET /billing/2020-11-05/organizations/{organization_id}/projects/{project_id}/account][%d] billingAccountServiceGetByProjectOK %s", 200, payload)
}
...
func (o *BillingAccountServiceGetByProjectDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /billing/2020-11-05/organizations/{organization_id}/projects/{project_id}/account][%d] BillingAccountService_GetByProject default %s", o._statusCode, payload)
}
