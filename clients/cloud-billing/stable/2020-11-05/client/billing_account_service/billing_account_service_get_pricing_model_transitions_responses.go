...
func (o *BillingAccountServiceGetPricingModelTransitionsOK) Error() string {
	...
	return fmt.Sprintf("[GET /billing/2020-11-05/organizations/{organization_id}/accounts/{billing_account_id}/pricing-model-transitions][%d] billingAccountServiceGetPricingModelTransitionsOK %s", 200, payload)
}
...
func (o *BillingAccountServiceGetPricingModelTransitionsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /billing/2020-11-05/organizations/{organization_id}/accounts/{billing_account_id}/pricing-model-transitions][%d] BillingAccountService_GetPricingModelTransitions default %s", o._statusCode, payload)
}
