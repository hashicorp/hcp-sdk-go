...
func (o *BillingAccountServiceUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PUT /billing/2020-11-05/organizations/{organization_id}/accounts/{id}][%d] billingAccountServiceUpdateOK %s", 200, payload)
}
...
func (o *BillingAccountServiceUpdateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /billing/2020-11-05/organizations/{organization_id}/accounts/{id}][%d] BillingAccountService_Update default %s", o._statusCode, payload)
}
