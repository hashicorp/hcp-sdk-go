...
func (o *ProductServiceEstimateCostOK) Error() string {
	...
	return fmt.Sprintf("[PUT /billing/2020-11-05/organizations/{organization_id}/estimateCost][%d] productServiceEstimateCostOK %s", 200, payload)
}
...
func (o *ProductServiceEstimateCostDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /billing/2020-11-05/organizations/{organization_id}/estimateCost][%d] ProductService_EstimateCost default %s", o._statusCode, payload)
}
