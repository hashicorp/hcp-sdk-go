...
func (o *ProductServiceListAvailablePackagesOK) Error() string {
	...
	return fmt.Sprintf("[GET /billing/2020-11-05/packages][%d] productServiceListAvailablePackagesOK %s", 200, payload)
}
...
func (o *ProductServiceListAvailablePackagesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /billing/2020-11-05/packages][%d] ProductService_ListAvailablePackages default %s", o._statusCode, payload)
}
