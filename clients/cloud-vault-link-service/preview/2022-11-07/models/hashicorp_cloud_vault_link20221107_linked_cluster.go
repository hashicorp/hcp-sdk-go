...
type HashicorpCloudVaultLink20221107LinkedCluster struct {
	...
	// node statuses
	NodeStatuses []*HashicorpCloudVaultLink20221107LinkedClusterNode `json:"nodeStatuses"`

	// raft quorum status
	RaftQuorumStatus *HashicorpCloudVaultLink20221107RaftQuorumStatus `json:"raftQuorumStatus,omitempty"`
