...
type GetLinkedClusterPolicyOK struct {
	Payload *cloud.VaultLink20221107GetLinkedClusterPolicyResponse
}
...
func (o *GetLinkedClusterPolicyOK) GetPayload() *cloud.VaultLink20221107GetLinkedClusterPolicyResponse {
	return o.Payload
}
...
func (o *GetLinkedClusterPolicyOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(cloud.VaultLink20221107GetLinkedClusterPolicyResponse)
...
func (o *GetLinkedClusterPolicyDefault) GetPayload() *cloud.RpcStatus {
	return o.Payload
}
