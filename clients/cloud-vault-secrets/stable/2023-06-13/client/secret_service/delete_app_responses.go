...
func (o *DeleteAppOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /secrets/2023-06-13/organizations/{location.organization_id}/projects/{location.project_id}/apps/{name}][%d] deleteAppOK %s", 200, payload)
}
...
func (o *DeleteAppDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /secrets/2023-06-13/organizations/{location.organization_id}/projects/{location.project_id}/apps/{name}][%d] DeleteApp default %s", o._statusCode, payload)
}
