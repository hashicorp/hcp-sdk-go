...
func (o *DeleteAppSecretVersionOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /secrets/2023-06-13/organizations/{location.organization_id}/projects/{location.project_id}/apps/{app_name}/secrets/{secret_name}/versions/{version}][%d] deleteAppSecretVersionOK %s", 200, payload)
}
...
func (o *DeleteAppSecretVersionDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /secrets/2023-06-13/organizations/{location.organization_id}/projects/{location.project_id}/apps/{app_name}/secrets/{secret_name}/versions/{version}][%d] DeleteAppSecretVersion default %s", o._statusCode, payload)
}
