...
func (o *ListAppSecretsOK) Error() string {
	...
	return fmt.Sprintf("[GET /secrets/2023-06-13/organizations/{location.organization_id}/projects/{location.project_id}/apps/{app_name}/secrets][%d] listAppSecretsOK %s", 200, payload)
}
...
func (o *ListAppSecretsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /secrets/2023-06-13/organizations/{location.organization_id}/projects/{location.project_id}/apps/{app_name}/secrets][%d] ListAppSecrets default %s", o._statusCode, payload)
}
