...
func (o *CreateHcpTerraformSyncIntegrationParams) WithBody(body CreateHcpTerraformSyncIntegrationBody) *CreateHcpTerraformSyncIntegrationParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create hcp terraform sync integration params
func (o *CreateHcpTerraformSyncIntegrationParams) SetBody(body CreateHcpTerraformSyncIntegrationBody) {
	o.Body = body
}
