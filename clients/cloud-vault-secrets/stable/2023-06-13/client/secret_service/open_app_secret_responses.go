...
func (o *OpenAppSecretOK) Error() string {
	...
	return fmt.Sprintf("[GET /secrets/2023-06-13/organizations/{location.organization_id}/projects/{location.project_id}/apps/{app_name}/open/{secret_name}][%d] openAppSecretOK %s", 200, payload)
}
...
func (o *OpenAppSecretDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /secrets/2023-06-13/organizations/{location.organization_id}/projects/{location.project_id}/apps/{app_name}/open/{secret_name}][%d] OpenAppSecret default %s", o._statusCode, payload)
}
