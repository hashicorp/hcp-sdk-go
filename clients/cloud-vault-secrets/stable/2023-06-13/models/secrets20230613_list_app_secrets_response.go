...
func (m *Secrets20230613ListAppSecretsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20230613ListAppSecretsResponse) validateSecrets(formats strfmt.Registry) error {
...
func (m *Secrets20230613ListAppSecretsResponse) contextValidateSecrets(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Secrets20230613ListAppSecretsResponse) UnmarshalBinary(b []byte) error {
	var res Secrets20230613ListAppSecretsResponse
