...
func (m *Secrets20230613OpenSecretVersion) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20230613OpenSecretVersion) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *Secrets20230613OpenSecretVersion) validateCreatedBy(formats strfmt.Registry) error {
...
func (m *Secrets20230613OpenSecretVersion) contextValidateCreatedBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Secrets20230613OpenSecretVersion) UnmarshalBinary(b []byte) error {
	var res Secrets20230613OpenSecretVersion
