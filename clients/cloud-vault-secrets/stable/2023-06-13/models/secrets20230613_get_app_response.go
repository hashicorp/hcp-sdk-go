...
func (m *Secrets20230613GetAppResponse) validateApp(formats strfmt.Registry) error {
...
func (m *Secrets20230613GetAppResponse) contextValidateApp(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Secrets20230613GetAppResponse) UnmarshalBinary(b []byte) error {
	var res Secrets20230613GetAppResponse
