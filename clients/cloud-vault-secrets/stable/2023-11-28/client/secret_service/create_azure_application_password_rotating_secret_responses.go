...
func (o *CreateAzureApplicationPasswordRotatingSecretReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCreateAzureApplicationPasswordRotatingSecretOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewCreateAzureApplicationPasswordRotatingSecretDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewCreateAzureApplicationPasswordRotatingSecretOK() *CreateAzureApplicationPasswordRotatingSecretOK {
	return &CreateAzureApplicationPasswordRotatingSecretOK{}
}
...
func (o *CreateAzureApplicationPasswordRotatingSecretOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.Secrets20231128CreateAzureApplicationPasswordRotatingSecretResponse)
...
func NewCreateAzureApplicationPasswordRotatingSecretDefault(code int) *CreateAzureApplicationPasswordRotatingSecretDefault {
	return &CreateAzureApplicationPasswordRotatingSecretDefault{
		_statusCode: code,
	}
}
...
func (o *CreateAzureApplicationPasswordRotatingSecretDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
