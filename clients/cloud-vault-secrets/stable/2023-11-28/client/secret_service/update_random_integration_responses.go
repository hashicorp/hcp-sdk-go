...
func (o *UpdateRandomIntegrationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUpdateRandomIntegrationOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewUpdateRandomIntegrationDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewUpdateRandomIntegrationOK() *UpdateRandomIntegrationOK {
	return &UpdateRandomIntegrationOK{}
}
...
func (o *UpdateRandomIntegrationOK) Error() string {
	...
	return fmt.Sprintf("[PUT /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/integrations/random/config/{name}][%d] updateRandomIntegrationOK %s", 200, payload)
}
...
func (o *UpdateRandomIntegrationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.Secrets20231128UpdateRandomIntegrationResponse)
...
func NewUpdateRandomIntegrationDefault(code int) *UpdateRandomIntegrationDefault {
	return &UpdateRandomIntegrationDefault{
		_statusCode: code,
	}
}
...
func (o *UpdateRandomIntegrationDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/integrations/random/config/{name}][%d] UpdateRandomIntegration default %s", o._statusCode, payload)
}
...
func (o *UpdateRandomIntegrationDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
