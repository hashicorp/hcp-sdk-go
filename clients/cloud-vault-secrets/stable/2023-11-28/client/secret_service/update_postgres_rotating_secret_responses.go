...
func (o *UpdatePostgresRotatingSecretOK) Error() string {
	...
	return fmt.Sprintf("[PUT /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps/{app_name}/rotating/postgres/secret/{name}][%d] updatePostgresRotatingSecretOK %s", 200, payload)
}
...
func (o *UpdatePostgresRotatingSecretDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps/{app_name}/rotating/postgres/secret/{name}][%d] UpdatePostgresRotatingSecret default %s", o._statusCode, payload)
}
