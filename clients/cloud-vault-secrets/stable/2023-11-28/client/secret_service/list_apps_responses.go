...
func (o *ListAppsOK) Error() string {
	...
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps][%d] listAppsOK %s", 200, payload)
}
...
func (o *ListAppsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps][%d] ListApps default %s", o._statusCode, payload)
}
