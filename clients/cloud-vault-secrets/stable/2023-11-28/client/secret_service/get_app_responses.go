...
func (o *GetAppOK) Error() string {
	...
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps/{name}][%d] getAppOK %s", 200, payload)
}
...
func (o *GetAppDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps/{name}][%d] GetApp default %s", o._statusCode, payload)
}
