...
func (o *GetAppOK) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps/{name}][%d] getAppOK  %+v", 200, o.Payload)
}
...
func (o *GetAppOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.Secrets20231128GetAppResponse)
...
func (o *GetAppDefault) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps/{name}][%d] GetApp default  %+v", o._statusCode, o.Payload)
}
