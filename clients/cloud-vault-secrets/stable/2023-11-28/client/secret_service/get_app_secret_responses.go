...
func (o *GetAppSecretOK) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps/{app_name}/secrets/{secret_name}][%d] getAppSecretOK  %+v", 200, o.Payload)
}
...
func (o *GetAppSecretOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.Secrets20231128GetAppSecretResponse)
...
func (o *GetAppSecretDefault) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps/{app_name}/secrets/{secret_name}][%d] GetAppSecret default  %+v", o._statusCode, o.Payload)
}
