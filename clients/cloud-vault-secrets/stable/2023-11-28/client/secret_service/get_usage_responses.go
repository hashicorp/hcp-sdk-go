...
func (o *GetUsageOK) Error() string {
	...
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/usage][%d] getUsageOK %s", 200, payload)
}
...
func (o *GetUsageDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/usage][%d] GetUsage default %s", o._statusCode, payload)
}
