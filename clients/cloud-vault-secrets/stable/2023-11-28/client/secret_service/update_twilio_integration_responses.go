...
func (o *UpdateTwilioIntegrationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUpdateTwilioIntegrationOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewUpdateTwilioIntegrationDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewUpdateTwilioIntegrationOK() *UpdateTwilioIntegrationOK {
	return &UpdateTwilioIntegrationOK{}
}
...
func (o *UpdateTwilioIntegrationOK) Error() string {
	return fmt.Sprintf("[PUT /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/integrations/twilio/config/{name}][%d] updateTwilioIntegrationOK  %+v", 200, o.Payload)
}
...
func (o *UpdateTwilioIntegrationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.Secrets20231128UpdateTwilioIntegrationResponse)
...
func NewUpdateTwilioIntegrationDefault(code int) *UpdateTwilioIntegrationDefault {
	return &UpdateTwilioIntegrationDefault{
		_statusCode: code,
	}
}
...
func (o *UpdateTwilioIntegrationDefault) Error() string {
	return fmt.Sprintf("[PUT /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/integrations/twilio/config/{name}][%d] UpdateTwilioIntegration default  %+v", o._statusCode, o.Payload)
}
...
func (o *UpdateTwilioIntegrationDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
