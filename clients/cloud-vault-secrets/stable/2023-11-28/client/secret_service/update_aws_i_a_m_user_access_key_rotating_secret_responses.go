...
func (o *UpdateAwsIAMUserAccessKeyRotatingSecretOK) Error() string {
	return fmt.Sprintf("[PUT /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps/{app_name}/rotating/aws/secret/{name}][%d] updateAwsIAMUserAccessKeyRotatingSecretOK  %+v", 200, o.Payload)
}
...
func (o *UpdateAwsIAMUserAccessKeyRotatingSecretDefault) Error() string {
	return fmt.Sprintf("[PUT /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps/{app_name}/rotating/aws/secret/{name}][%d] UpdateAwsIAMUserAccessKeyRotatingSecret default  %+v", o._statusCode, o.Payload)
}
