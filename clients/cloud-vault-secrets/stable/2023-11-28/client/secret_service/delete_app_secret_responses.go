...
func (o *DeleteAppSecretOK) Error() string {
	return fmt.Sprintf("[DELETE /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps/{app_name}/secrets/{secret_name}][%d] deleteAppSecretOK  %+v", 200, o.Payload)
}
...
func (o *DeleteAppSecretDefault) Error() string {
	return fmt.Sprintf("[DELETE /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps/{app_name}/secrets/{secret_name}][%d] DeleteAppSecret default  %+v", o._statusCode, o.Payload)
}
