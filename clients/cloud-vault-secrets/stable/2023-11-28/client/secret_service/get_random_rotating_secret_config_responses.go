...
func (o *GetRandomRotatingSecretConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetRandomRotatingSecretConfigOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewGetRandomRotatingSecretConfigDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetRandomRotatingSecretConfigOK() *GetRandomRotatingSecretConfigOK {
	return &GetRandomRotatingSecretConfigOK{}
}
...
func (o *GetRandomRotatingSecretConfigOK) Error() string {
	...
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps/{app_name}/rotating/random/secret/{name}][%d] getRandomRotatingSecretConfigOK %s", 200, payload)
}
...
func (o *GetRandomRotatingSecretConfigOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.Secrets20231128GetRandomRotatingSecretConfigResponse)
...
func NewGetRandomRotatingSecretConfigDefault(code int) *GetRandomRotatingSecretConfigDefault {
	return &GetRandomRotatingSecretConfigDefault{
		_statusCode: code,
	}
}
...
func (o *GetRandomRotatingSecretConfigDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps/{app_name}/rotating/random/secret/{name}][%d] GetRandomRotatingSecretConfig default %s", o._statusCode, payload)
}
...
func (o *GetRandomRotatingSecretConfigDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
