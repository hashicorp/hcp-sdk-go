...
func (m *Secrets20231128GetPostgresIntegrationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128GetPostgresIntegrationResponse) validateIntegration(formats strfmt.Registry) error {
...
func (m *Secrets20231128GetPostgresIntegrationResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128GetPostgresIntegrationResponse) contextValidateIntegration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Secrets20231128GetPostgresIntegrationResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Secrets20231128GetPostgresIntegrationResponse) UnmarshalBinary(b []byte) error {
	var res Secrets20231128GetPostgresIntegrationResponse
