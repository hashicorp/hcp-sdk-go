...
func (m *Secrets20231128UpdateAppRotatingSecretResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128UpdateAppRotatingSecretResponse) validateSecret(formats strfmt.Registry) error {
...
func (m *Secrets20231128UpdateAppRotatingSecretResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128UpdateAppRotatingSecretResponse) contextValidateSecret(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Secrets20231128UpdateAppRotatingSecretResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Secrets20231128UpdateAppRotatingSecretResponse) UnmarshalBinary(b []byte) error {
	var res Secrets20231128UpdateAppRotatingSecretResponse
