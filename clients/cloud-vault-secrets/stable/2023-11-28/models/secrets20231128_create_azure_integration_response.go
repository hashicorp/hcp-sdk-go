...
func (m *Secrets20231128CreateAzureIntegrationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128CreateAzureIntegrationResponse) validateIntegration(formats strfmt.Registry) error {
...
func (m *Secrets20231128CreateAzureIntegrationResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128CreateAzureIntegrationResponse) contextValidateIntegration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Secrets20231128CreateAzureIntegrationResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Secrets20231128CreateAzureIntegrationResponse) UnmarshalBinary(b []byte) error {
	var res Secrets20231128CreateAzureIntegrationResponse
