...
func (m *Secrets20231128CreatePostgresIntegrationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128CreatePostgresIntegrationResponse) validateIntegration(formats strfmt.Registry) error {
...
func (m *Secrets20231128CreatePostgresIntegrationResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128CreatePostgresIntegrationResponse) contextValidateIntegration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Secrets20231128CreatePostgresIntegrationResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Secrets20231128CreatePostgresIntegrationResponse) UnmarshalBinary(b []byte) error {
	var res Secrets20231128CreatePostgresIntegrationResponse
