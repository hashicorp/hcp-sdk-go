...
func (m *Secrets20231128UpdateAzureIntegrationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128UpdateAzureIntegrationResponse) validateIntegration(formats strfmt.Registry) error {
...
func (m *Secrets20231128UpdateAzureIntegrationResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128UpdateAzureIntegrationResponse) contextValidateIntegration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Secrets20231128UpdateAzureIntegrationResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Secrets20231128UpdateAzureIntegrationResponse) UnmarshalBinary(b []byte) error {
	var res Secrets20231128UpdateAzureIntegrationResponse
