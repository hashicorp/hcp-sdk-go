...
func (m *SecretServiceCreatePostgresIntegrationBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SecretServiceCreatePostgresIntegrationBody) validateCapabilities(formats strfmt.Registry) error {
...
func (m *SecretServiceCreatePostgresIntegrationBody) validateStaticCredentialDetails(formats strfmt.Registry) error {
...
func (m *SecretServiceCreatePostgresIntegrationBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SecretServiceCreatePostgresIntegrationBody) contextValidateCapabilities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SecretServiceCreatePostgresIntegrationBody) contextValidateStaticCredentialDetails(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SecretServiceCreatePostgresIntegrationBody) UnmarshalBinary(b []byte) error {
	var res SecretServiceCreatePostgresIntegrationBody
