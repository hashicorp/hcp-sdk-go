...
func (m *Secrets20231128CreateRandomIntegrationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128CreateRandomIntegrationResponse) validateIntegration(formats strfmt.Registry) error {
...
func (m *Secrets20231128CreateRandomIntegrationResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128CreateRandomIntegrationResponse) contextValidateIntegration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Secrets20231128CreateRandomIntegrationResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Secrets20231128CreateRandomIntegrationResponse) UnmarshalBinary(b []byte) error {
	var res Secrets20231128CreateRandomIntegrationResponse
