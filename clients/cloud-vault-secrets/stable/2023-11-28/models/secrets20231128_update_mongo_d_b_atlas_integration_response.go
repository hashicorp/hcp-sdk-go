...
func (m *Secrets20231128UpdateMongoDBAtlasIntegrationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128UpdateMongoDBAtlasIntegrationResponse) validateIntegration(formats strfmt.Registry) error {
...
func (m *Secrets20231128UpdateMongoDBAtlasIntegrationResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128UpdateMongoDBAtlasIntegrationResponse) contextValidateIntegration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Secrets20231128UpdateMongoDBAtlasIntegrationResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Secrets20231128UpdateMongoDBAtlasIntegrationResponse) UnmarshalBinary(b []byte) error {
	var res Secrets20231128UpdateMongoDBAtlasIntegrationResponse
