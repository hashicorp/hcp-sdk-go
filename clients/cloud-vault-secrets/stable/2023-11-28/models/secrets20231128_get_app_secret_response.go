...
func (m *Secrets20231128GetAppSecretResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128GetAppSecretResponse) validateSecret(formats strfmt.Registry) error {
...
func (m *Secrets20231128GetAppSecretResponse) contextValidateSecret(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Secrets20231128GetAppSecretResponse) UnmarshalBinary(b []byte) error {
	var res Secrets20231128GetAppSecretResponse
