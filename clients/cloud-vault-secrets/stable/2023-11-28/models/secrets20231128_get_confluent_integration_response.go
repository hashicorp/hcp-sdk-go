...
func (m *Secrets20231128GetConfluentIntegrationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128GetConfluentIntegrationResponse) validateIntegration(formats strfmt.Registry) error {
...
func (m *Secrets20231128GetConfluentIntegrationResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128GetConfluentIntegrationResponse) contextValidateIntegration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Secrets20231128GetConfluentIntegrationResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Secrets20231128GetConfluentIntegrationResponse) UnmarshalBinary(b []byte) error {
	var res Secrets20231128GetConfluentIntegrationResponse
