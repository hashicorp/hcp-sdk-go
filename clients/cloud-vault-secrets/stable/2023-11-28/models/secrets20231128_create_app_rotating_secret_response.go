...
func (m *Secrets20231128CreateAppRotatingSecretResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128CreateAppRotatingSecretResponse) validateSecret(formats strfmt.Registry) error {
...
func (m *Secrets20231128CreateAppRotatingSecretResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128CreateAppRotatingSecretResponse) contextValidateSecret(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Secrets20231128CreateAppRotatingSecretResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Secrets20231128CreateAppRotatingSecretResponse) UnmarshalBinary(b []byte) error {
	var res Secrets20231128CreateAppRotatingSecretResponse
