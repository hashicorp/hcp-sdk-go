...
func (o *GetUsageOK) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/usage][%d] getUsageOK  %+v", 200, o.Payload)
}
...
func (o *GetUsageDefault) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/usage][%d] GetUsage default  %+v", o._statusCode, o.Payload)
}
