...
func (o *GetGitHubInstallLinksOK) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/github/links][%d] getGitHubInstallLinksOK  %+v", 200, o.Payload)
}
...
func (o *GetGitHubInstallLinksOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.Secrets20231128GetGitHubInstallLinksResponse)
...
func (o *GetGitHubInstallLinksDefault) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/github/links][%d] GetGitHubInstallLinks default  %+v", o._statusCode, o.Payload)
}
...
func (o *GetGitHubInstallLinksDefault) GetPayload() *models.GooglerpcStatus {
	return o.Payload
}
