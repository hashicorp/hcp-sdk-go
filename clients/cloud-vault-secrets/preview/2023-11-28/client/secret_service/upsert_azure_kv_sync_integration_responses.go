...
func (o *UpsertAzureKvSyncIntegrationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUpsertAzureKvSyncIntegrationOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewUpsertAzureKvSyncIntegrationDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewUpsertAzureKvSyncIntegrationOK() *UpsertAzureKvSyncIntegrationOK {
	return &UpsertAzureKvSyncIntegrationOK{}
}
...
func (o *UpsertAzureKvSyncIntegrationOK) Code() int {
	return 200
}

func (o *UpsertAzureKvSyncIntegrationOK) Error() string {
	return fmt.Sprintf("[PUT /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/azure-kv][%d] upsertAzureKvSyncIntegrationOK  %+v", 200, o.Payload)
}

func (o *UpsertAzureKvSyncIntegrationOK) String() string {
	return fmt.Sprintf("[PUT /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/azure-kv][%d] upsertAzureKvSyncIntegrationOK  %+v", 200, o.Payload)
}

func (o *UpsertAzureKvSyncIntegrationOK) GetPayload() *models.Secrets20231128UpsertSyncIntegrationResponse {
	return o.Payload
}

func (o *UpsertAzureKvSyncIntegrationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewUpsertAzureKvSyncIntegrationDefault(code int) *UpsertAzureKvSyncIntegrationDefault {
	return &UpsertAzureKvSyncIntegrationDefault{
		_statusCode: code,
	}
}
...
func (o *UpsertAzureKvSyncIntegrationDefault) IsSuccess() bool {
...
func (o *UpsertAzureKvSyncIntegrationDefault) IsCode(code int) bool {
	return o._statusCode == code
}

// Code gets the status code for the upsert azure kv sync integration default response
func (o *UpsertAzureKvSyncIntegrationDefault) Code() int {
	return o._statusCode
}

func (o *UpsertAzureKvSyncIntegrationDefault) Error() string {
	return fmt.Sprintf("[PUT /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/azure-kv][%d] UpsertAzureKvSyncIntegration default  %+v", o._statusCode, o.Payload)
}

func (o *UpsertAzureKvSyncIntegrationDefault) String() string {
	return fmt.Sprintf("[PUT /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/azure-kv][%d] UpsertAzureKvSyncIntegration default  %+v", o._statusCode, o.Payload)
}

func (o *UpsertAzureKvSyncIntegrationDefault) GetPayload() *models.RPCStatus {
	return o.Payload
}

func (o *UpsertAzureKvSyncIntegrationDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
/*
UpsertAzureKvSyncIntegrationBody upsert azure kv sync integration body
swagger:model UpsertAzureKvSyncIntegrationBody
*/
...
func (o *UpsertAzureKvSyncIntegrationBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *UpsertAzureKvSyncIntegrationBody) validateAzureKvConnectionDetails(formats strfmt.Registry) error {
...
func (o *UpsertAzureKvSyncIntegrationBody) contextValidateAzureKvConnectionDetails(ctx context.Context, formats strfmt.Registry) error {
...
func (o *UpsertAzureKvSyncIntegrationBody) UnmarshalBinary(b []byte) error {
	var res UpsertAzureKvSyncIntegrationBody
