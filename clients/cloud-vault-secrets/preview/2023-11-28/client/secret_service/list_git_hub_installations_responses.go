...
func (o *ListGitHubInstallationsOK) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/github/installations][%d] listGitHubInstallationsOK  %+v", 200, o.Payload)
}
...
func (o *ListGitHubInstallationsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.Secrets20231128ListGitHubInstallationsResponse)
...
func (o *ListGitHubInstallationsDefault) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/github/installations][%d] ListGitHubInstallations default  %+v", o._statusCode, o.Payload)
}
...
func (o *ListGitHubInstallationsDefault) GetPayload() *models.GooglerpcStatus {
	return o.Payload
}
