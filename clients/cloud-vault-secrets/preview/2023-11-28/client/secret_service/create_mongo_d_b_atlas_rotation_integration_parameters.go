...
// NewCreateMongoDBAtlasRotationIntegrationParams creates a new CreateMongoDBAtlasRotationIntegrationParams object,
...
func NewCreateMongoDBAtlasRotationIntegrationParams() *CreateMongoDBAtlasRotationIntegrationParams {
	return &CreateMongoDBAtlasRotationIntegrationParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewCreateMongoDBAtlasRotationIntegrationParamsWithTimeout creates a new CreateMongoDBAtlasRotationIntegrationParams object
...
// NewCreateMongoDBAtlasRotationIntegrationParamsWithContext creates a new CreateMongoDBAtlasRotationIntegrationParams object
...
// NewCreateMongoDBAtlasRotationIntegrationParamsWithHTTPClient creates a new CreateMongoDBAtlasRotationIntegrationParams object
...
func (o *CreateMongoDBAtlasRotationIntegrationParams) WithDefaults() *CreateMongoDBAtlasRotationIntegrationParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *CreateMongoDBAtlasRotationIntegrationParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the create mongo d b atlas rotation integration params
func (o *CreateMongoDBAtlasRotationIntegrationParams) WithTimeout(timeout time.Duration) *CreateMongoDBAtlasRotationIntegrationParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the create mongo d b atlas rotation integration params
func (o *CreateMongoDBAtlasRotationIntegrationParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the create mongo d b atlas rotation integration params
func (o *CreateMongoDBAtlasRotationIntegrationParams) WithContext(ctx context.Context) *CreateMongoDBAtlasRotationIntegrationParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the create mongo d b atlas rotation integration params
func (o *CreateMongoDBAtlasRotationIntegrationParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the create mongo d b atlas rotation integration params
func (o *CreateMongoDBAtlasRotationIntegrationParams) WithHTTPClient(client *http.Client) *CreateMongoDBAtlasRotationIntegrationParams {
...
func (o *CreateMongoDBAtlasRotationIntegrationParams) WithBody(body CreateMongoDBAtlasRotationIntegrationBody) *CreateMongoDBAtlasRotationIntegrationParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create mongo d b atlas rotation integration params
func (o *CreateMongoDBAtlasRotationIntegrationParams) SetBody(body CreateMongoDBAtlasRotationIntegrationBody) {
	o.Body = body
}

// WithOrganizationID adds the organizationID to the create mongo d b atlas rotation integration params
func (o *CreateMongoDBAtlasRotationIntegrationParams) WithOrganizationID(organizationID string) *CreateMongoDBAtlasRotationIntegrationParams {
...
func (o *CreateMongoDBAtlasRotationIntegrationParams) WithProjectID(projectID string) *CreateMongoDBAtlasRotationIntegrationParams {
...
func (o *CreateMongoDBAtlasRotationIntegrationParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
