...
func (o *GetGitHubEnvironmentsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetGitHubEnvironmentsOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewGetGitHubEnvironmentsDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewGetGitHubEnvironmentsOK() *GetGitHubEnvironmentsOK {
	return &GetGitHubEnvironmentsOK{}
}
...
func (o *GetGitHubEnvironmentsOK) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/github/repositories/{repository}/environments][%d] getGitHubEnvironmentsOK  %+v", 200, o.Payload)
}
...
func (o *GetGitHubEnvironmentsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.Secrets20231128GetGitHubEnvironmentsResponse)
...
func NewGetGitHubEnvironmentsDefault(code int) *GetGitHubEnvironmentsDefault {
	return &GetGitHubEnvironmentsDefault{
		_statusCode: code,
	}
}
...
func (o *GetGitHubEnvironmentsDefault) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/github/repositories/{repository}/environments][%d] GetGitHubEnvironments default  %+v", o._statusCode, o.Payload)
}
...
func (o *GetGitHubEnvironmentsDefault) GetPayload() *models.GooglerpcStatus {
	return o.Payload
}

func (o *GetGitHubEnvironmentsDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
