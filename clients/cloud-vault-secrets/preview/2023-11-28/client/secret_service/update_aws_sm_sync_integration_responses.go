...
func (o *UpdateAwsSmSyncIntegrationOK) Error() string {
	return fmt.Sprintf("[PATCH /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/aws-sm/{name}][%d] updateAwsSmSyncIntegrationOK  %+v", 200, o.Payload)
}
...
func (o *UpdateAwsSmSyncIntegrationDefault) Error() string {
	return fmt.Sprintf("[PATCH /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/aws-sm/{name}][%d] UpdateAwsSmSyncIntegration default  %+v", o._statusCode, o.Payload)
}
