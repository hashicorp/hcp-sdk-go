...
func (o *GetSyncIntegrationOK) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/integrations/{name}][%d] getSyncIntegrationOK  %+v", 200, o.Payload)
}
...
func (o *GetSyncIntegrationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.Secrets20231128GetSyncIntegrationResponse)
...
func (o *GetSyncIntegrationDefault) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/integrations/{name}][%d] GetSyncIntegration default  %+v", o._statusCode, o.Payload)
}
...
func (o *GetSyncIntegrationDefault) GetPayload() *models.GooglerpcStatus {
	return o.Payload
}
