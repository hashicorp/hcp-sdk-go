...
func (o *CompleteGitHubInstallOK) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/sync/github/callback][%d] completeGitHubInstallOK  %+v", 200, o.Payload)
}
...
func (o *CompleteGitHubInstallDefault) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/sync/github/callback][%d] CompleteGitHubInstall default  %+v", o._statusCode, o.Payload)
}
...
func (o *CompleteGitHubInstallDefault) GetPayload() *models.GooglerpcStatus {
	return o.Payload
}
