...
func (o *GetVercelInstallationLinkOK) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/vercel/link][%d] getVercelInstallationLinkOK  %+v", 200, o.Payload)
}
...
func (o *GetVercelInstallationLinkOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.Secrets20231128GetVercelInstallationLinkResponse)
...
func (o *GetVercelInstallationLinkDefault) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/vercel/link][%d] GetVercelInstallationLink default  %+v", o._statusCode, o.Payload)
}
...
func (o *GetVercelInstallationLinkDefault) GetPayload() *models.GooglerpcStatus {
	return o.Payload
}
