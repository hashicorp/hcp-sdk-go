...
func (o *GetTwilioRotatingSecretConfigOK) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps/{app_name}/secret/rotating/twilio/{secret_name}][%d] getTwilioRotatingSecretConfigOK  %+v", 200, o.Payload)
}
...
func (o *GetTwilioRotatingSecretConfigDefault) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps/{app_name}/secret/rotating/twilio/{secret_name}][%d] GetTwilioRotatingSecretConfig default  %+v", o._statusCode, o.Payload)
}
