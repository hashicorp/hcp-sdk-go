...
func (o *GetGitHubRepositoriesOK) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/github/repositories][%d] getGitHubRepositoriesOK  %+v", 200, o.Payload)
}
...
func (o *GetGitHubRepositoriesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.Secrets20231128GetGitHubRepositoriesResponse)
...
func (o *GetGitHubRepositoriesDefault) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/github/repositories][%d] GetGitHubRepositories default  %+v", o._statusCode, o.Payload)
}
...
func (o *GetGitHubRepositoriesDefault) GetPayload() *models.GooglerpcStatus {
	return o.Payload
}
