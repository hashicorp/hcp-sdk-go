...
func (o *ListSyncIntegrationsOK) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/integrations][%d] listSyncIntegrationsOK  %+v", 200, o.Payload)
}
...
func (o *ListSyncIntegrationsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.Secrets20231128ListSyncIntegrationsResponse)
...
func (o *ListSyncIntegrationsDefault) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/integrations][%d] ListSyncIntegrations default  %+v", o._statusCode, o.Payload)
}
...
func (o *ListSyncIntegrationsDefault) GetPayload() *models.GooglerpcStatus {
	return o.Payload
}
