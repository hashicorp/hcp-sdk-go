...
func (o *UpsertAwsSmSyncIntegrationOK) Error() string {
	return fmt.Sprintf("[PUT /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/aws-sm][%d] upsertAwsSmSyncIntegrationOK  %+v", 200, o.Payload)
}
...
func (o *UpsertAwsSmSyncIntegrationDefault) Error() string {
	return fmt.Sprintf("[PUT /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/aws-sm][%d] UpsertAwsSmSyncIntegration default  %+v", o._statusCode, o.Payload)
}
