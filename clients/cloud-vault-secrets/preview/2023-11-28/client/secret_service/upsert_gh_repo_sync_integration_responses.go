...
func (o *UpsertGhRepoSyncIntegrationOK) Error() string {
	return fmt.Sprintf("[PUT /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/gh-repo][%d] upsertGhRepoSyncIntegrationOK  %+v", 200, o.Payload)
}
...
func (o *UpsertGhRepoSyncIntegrationDefault) Error() string {
	return fmt.Sprintf("[PUT /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/gh-repo][%d] UpsertGhRepoSyncIntegration default  %+v", o._statusCode, o.Payload)
}
