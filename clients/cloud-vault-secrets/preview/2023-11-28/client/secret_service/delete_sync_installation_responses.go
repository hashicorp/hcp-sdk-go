...
func (o *DeleteSyncInstallationOK) Error() string {
	return fmt.Sprintf("[DELETE /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/installations/{name}][%d] deleteSyncInstallationOK  %+v", 200, o.Payload)
}
...
func (o *DeleteSyncInstallationDefault) Error() string {
	return fmt.Sprintf("[DELETE /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/sync/installations/{name}][%d] DeleteSyncInstallation default  %+v", o._statusCode, o.Payload)
}
...
func (o *DeleteSyncInstallationDefault) GetPayload() *models.GooglerpcStatus {
	return o.Payload
}
