...
func (o *GetIntegrationOK) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/integrations/{name}][%d] getIntegrationOK  %+v", 200, o.Payload)
}
...
func (o *GetIntegrationDefault) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/integrations/{name}][%d] GetIntegration default  %+v", o._statusCode, o.Payload)
}
