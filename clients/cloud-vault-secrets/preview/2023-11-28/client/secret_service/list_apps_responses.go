...
func (o *ListAppsOK) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps][%d] listAppsOK  %+v", 200, o.Payload)
}
...
func (o *ListAppsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.Secrets20231128ListAppsResponse)
...
func (o *ListAppsDefault) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps][%d] ListApps default  %+v", o._statusCode, o.Payload)
}
