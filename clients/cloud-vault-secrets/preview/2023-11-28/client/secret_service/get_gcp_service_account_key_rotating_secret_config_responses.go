...
func (o *GetGcpServiceAccountKeyRotatingSecretConfigOK) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps/{app_name}/rotating/gcp/secret/{name}][%d] getGcpServiceAccountKeyRotatingSecretConfigOK  %+v", 200, o.Payload)
}
...
func (o *GetGcpServiceAccountKeyRotatingSecretConfigDefault) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps/{app_name}/rotating/gcp/secret/{name}][%d] GetGcpServiceAccountKeyRotatingSecretConfig default  %+v", o._statusCode, o.Payload)
}
