...
func (o *ListAppSecretVersionsOK) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps/{app_name}/secrets/{secret_name}/versions][%d] listAppSecretVersionsOK  %+v", 200, o.Payload)
}
...
func (o *ListAppSecretVersionsDefault) Error() string {
	return fmt.Sprintf("[GET /secrets/2023-11-28/organizations/{organization_id}/projects/{project_id}/apps/{app_name}/secrets/{secret_name}/versions][%d] ListAppSecretVersions default  %+v", o._statusCode, o.Payload)
}
