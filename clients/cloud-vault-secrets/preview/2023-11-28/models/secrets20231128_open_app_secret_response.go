...
func (m *Secrets20231128OpenAppSecretResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128OpenAppSecretResponse) validateSecret(formats strfmt.Registry) error {
...
func (m *Secrets20231128OpenAppSecretResponse) contextValidateSecret(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Secrets20231128OpenAppSecretResponse) UnmarshalBinary(b []byte) error {
	var res Secrets20231128OpenAppSecretResponse
