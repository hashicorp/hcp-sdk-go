...
func (m *Secrets20231128ListMongoDBAtlasIntegrationsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128ListMongoDBAtlasIntegrationsResponse) validateIntegrations(formats strfmt.Registry) error {
...
func (m *Secrets20231128ListMongoDBAtlasIntegrationsResponse) validatePagination(formats strfmt.Registry) error {
...
func (m *Secrets20231128ListMongoDBAtlasIntegrationsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128ListMongoDBAtlasIntegrationsResponse) contextValidateIntegrations(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Secrets20231128ListMongoDBAtlasIntegrationsResponse) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Secrets20231128ListMongoDBAtlasIntegrationsResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Secrets20231128ListMongoDBAtlasIntegrationsResponse) UnmarshalBinary(b []byte) error {
	var res Secrets20231128ListMongoDBAtlasIntegrationsResponse
