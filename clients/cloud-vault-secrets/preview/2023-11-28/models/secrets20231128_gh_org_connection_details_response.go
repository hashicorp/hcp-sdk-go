...
func (m *Secrets20231128GhOrgConnectionDetailsResponse) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this secrets 20231128 gh org connection details response based on context it is used
func (m *Secrets20231128GhOrgConnectionDetailsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *Secrets20231128GhOrgConnectionDetailsResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Secrets20231128GhOrgConnectionDetailsResponse) UnmarshalBinary(b []byte) error {
	var res Secrets20231128GhOrgConnectionDetailsResponse
