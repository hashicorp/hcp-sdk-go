...
func (m *Secrets20231128GetIntegrationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Secrets20231128GetIntegrationResponse) validateIntegration(formats strfmt.Registry) error {
...
func (m *Secrets20231128GetIntegrationResponse) contextValidateIntegration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Secrets20231128GetIntegrationResponse) UnmarshalBinary(b []byte) error {
	var res Secrets20231128GetIntegrationResponse
