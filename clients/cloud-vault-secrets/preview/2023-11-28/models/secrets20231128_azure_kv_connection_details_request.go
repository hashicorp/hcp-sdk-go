...
func (m *Secrets20231128AzureKvConnectionDetailsRequest) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this secrets 20231128 azure kv connection details request based on context it is used
func (m *Secrets20231128AzureKvConnectionDetailsRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *Secrets20231128AzureKvConnectionDetailsRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Secrets20231128AzureKvConnectionDetailsRequest) UnmarshalBinary(b []byte) error {
	var res Secrets20231128AzureKvConnectionDetailsRequest
