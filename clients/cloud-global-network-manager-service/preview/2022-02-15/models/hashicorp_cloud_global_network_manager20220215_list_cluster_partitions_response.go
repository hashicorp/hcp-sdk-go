...
func (m *HashicorpCloudGlobalNetworkManager20220215ListClusterPartitionsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudGlobalNetworkManager20220215ListClusterPartitionsResponse) validatePartitions(formats strfmt.Registry) error {
...
func (m *HashicorpCloudGlobalNetworkManager20220215ListClusterPartitionsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudGlobalNetworkManager20220215ListClusterPartitionsResponse) contextValidatePartitions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudGlobalNetworkManager20220215ListClusterPartitionsResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HashicorpCloudGlobalNetworkManager20220215ListClusterPartitionsResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudGlobalNetworkManager20220215ListClusterPartitionsResponse
