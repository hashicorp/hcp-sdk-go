...
func init() {
	...
	if err := json.Unmarshal([]byte(`["INELIGIBILITY_UNDEFINED","INELIGIBILITY_MIN_VERSION_NOT_MET","INELIGIBILITY_PEERING_NOT_ENABLED","INELIGIBILITY_CROSS_CLOUD_PREMIUM_TIER_REQUIRED","INELIGIBILITY_CROSS_REGION_PLUS_TIER_REQUIRED","INELIGIBILITY_NO_CONNECTIVITY_POSSIBLE","INELIGIBILITY_INELIGIBLE_BILLING_PLAN","INELIGIBILITY_CLUSTER_INVALID_STATE"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
