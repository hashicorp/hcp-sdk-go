...
func (a *Client) AgentTelemetryConfig(params *AgentTelemetryConfigParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*AgentTelemetryConfigOK, error) {
	...
	op := &runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/global-network-manager/2022-02-15/observability/organizations/{location.organization_id}/projects/{location.project_id}/clusters/{cluster_id}/agent/telemetry_config",
