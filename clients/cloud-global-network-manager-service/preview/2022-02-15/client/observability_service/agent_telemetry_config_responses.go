...
func (o *AgentTelemetryConfigOK) Error() string {
	return fmt.Sprintf("[GET /global-network-manager/2022-02-15/observability/organizations/{location.organization_id}/projects/{location.project_id}/clusters/{cluster_id}/agent/telemetry_config][%d] agentTelemetryConfigOK  %+v", 200, o.Payload)
}
...
func (o *AgentTelemetryConfigOK) GetPayload() *models.HashicorpCloudGlobalNetworkManager20220215ObservabilityAgentTelemetryConfigResponse {
	return o.Payload
}
...
func (o *AgentTelemetryConfigOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.HashicorpCloudGlobalNetworkManager20220215ObservabilityAgentTelemetryConfigResponse)
...
func (o *AgentTelemetryConfigDefault) Error() string {
	return fmt.Sprintf("[GET /global-network-manager/2022-02-15/observability/organizations/{location.organization_id}/projects/{location.project_id}/clusters/{cluster_id}/agent/telemetry_config][%d] AgentTelemetryConfig default  %+v", o._statusCode, o.Payload)
}
