...
// NewListPeersByClusterPartitionParams creates a new ListPeersByClusterPartitionParams object,
...
func NewListPeersByClusterPartitionParams() *ListPeersByClusterPartitionParams {
	return &ListPeersByClusterPartitionParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewListPeersByClusterPartitionParamsWithTimeout creates a new ListPeersByClusterPartitionParams object
...
// NewListPeersByClusterPartitionParamsWithContext creates a new ListPeersByClusterPartitionParams object
...
// NewListPeersByClusterPartitionParamsWithHTTPClient creates a new ListPeersByClusterPartitionParams object
...
func (o *ListPeersByClusterPartitionParams) WithDefaults() *ListPeersByClusterPartitionParams {
	o.SetDefaults()
	return o
}
...
func (o *ListPeersByClusterPartitionParams) WithTimeout(timeout time.Duration) *ListPeersByClusterPartitionParams {
...
func (o *ListPeersByClusterPartitionParams) WithContext(ctx context.Context) *ListPeersByClusterPartitionParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list peers by cluster partition params
func (o *ListPeersByClusterPartitionParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list peers by cluster partition params
func (o *ListPeersByClusterPartitionParams) WithHTTPClient(client *http.Client) *ListPeersByClusterPartitionParams {
...
func (o *ListPeersByClusterPartitionParams) WithClusterID(clusterID *string) *ListPeersByClusterPartitionParams {
...
func (o *ListPeersByClusterPartitionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
