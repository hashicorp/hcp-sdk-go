...
type ListClustersOK struct {
	Payload *models.HashicorpCloudConsulCloudManager20231010ListClustersResponse
}
...
func (o *ListClustersOK) Error() string {
	return fmt.Sprintf("[GET /2023-10-10/consul/{parent_resource_name}/clusters][%d] listClustersOK  %+v", 200, o.Payload)
}
...
func (o *ListClustersOK) GetPayload() *models.HashicorpCloudConsulCloudManager20231010ListClustersResponse {
	return o.Payload
}
...
func (o *ListClustersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.HashicorpCloudConsulCloudManager20231010ListClustersResponse)
...
func (o *ListClustersDefault) Error() string {
	return fmt.Sprintf("[GET /2023-10-10/consul/{parent_resource_name}/clusters][%d] ListClusters default  %+v", o._statusCode, o.Payload)
}
