...
func (o *GetServiceInstanceDefault) Error() string {
	return fmt.Sprintf("[GET /2023-10-10/{cluster_resource_name}/node/{node}/service/{service_name}/instance/{instance_id}][%d] GetServiceInstance default  %+v", o._statusCode, o.Payload)
}
