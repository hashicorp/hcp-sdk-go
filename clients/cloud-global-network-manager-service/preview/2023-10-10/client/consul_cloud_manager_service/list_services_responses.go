...
func (o *ListServicesOK) Error() string {
	return fmt.Sprintf("[GET /2023-10-10/consul/{project_resource_name}/services][%d] listServicesOK  %+v", 200, o.Payload)
}
...
func (o *ListServicesDefault) Error() string {
	return fmt.Sprintf("[GET /2023-10-10/consul/{project_resource_name}/services][%d] ListServices default  %+v", o._statusCode, o.Payload)
}
