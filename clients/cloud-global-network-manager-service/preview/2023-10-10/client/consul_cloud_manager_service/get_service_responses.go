...
func (o *GetServiceOK) Error() string {
	return fmt.Sprintf("[GET /2023-10-10/{cluster_resource_name}/service/{service_name}][%d] getServiceOK  %+v", 200, o.Payload)
}
...
func (o *GetServiceDefault) Error() string {
	return fmt.Sprintf("[GET /2023-10-10/{cluster_resource_name}/service/{service_name}][%d] GetService default  %+v", o._statusCode, o.Payload)
}
