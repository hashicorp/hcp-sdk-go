...
type GetClusterOK struct {
	Payload *models.HashicorpCloudConsulCloudManager20231010GetClusterResponse
}
...
func (o *GetClusterOK) Error() string {
	return fmt.Sprintf("[GET /2023-10-10/{resource_name}][%d] getClusterOK  %+v", 200, o.Payload)
}
...
func (o *GetClusterOK) GetPayload() *models.HashicorpCloudConsulCloudManager20231010GetClusterResponse {
	return o.Payload
}

func (o *GetClusterOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.HashicorpCloudConsulCloudManager20231010GetClusterResponse)
...
func (o *GetClusterDefault) Error() string {
	return fmt.Sprintf("[GET /2023-10-10/{resource_name}][%d] GetCluster default  %+v", o._statusCode, o.Payload)
}
