...
func (m *HashicorpCloudPackerGetChannelResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudPackerGetChannelResponse) validateChannel(formats strfmt.Registry) error {
...
func (m *HashicorpCloudPackerGetChannelResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudPackerGetChannelResponse) contextValidateChannel(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudPackerGetChannelResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudPackerGetChannelResponse
