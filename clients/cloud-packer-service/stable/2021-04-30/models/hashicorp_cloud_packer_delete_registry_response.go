...
func (m *HashicorpCloudPackerDeleteRegistryResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudPackerDeleteRegistryResponse) contextValidateOperation(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudPackerDeleteRegistryResponse) contextValidateRegistry(ctx context.Context, formats strfmt.Registry) error {
