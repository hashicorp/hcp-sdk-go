...
func (o *PackerServiceGetRegistryTFCRunTaskAPIOK) Error() string {
	...
	return fmt.Sprintf("[GET /packer/2021-04-30/organizations/{location.organization_id}/projects/{location.project_id}/runtasks/{task_type}][%d] packerServiceGetRegistryTFCRunTaskApiOK %s", 200, payload)
}
...
func (o *PackerServiceGetRegistryTFCRunTaskAPIDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /packer/2021-04-30/organizations/{location.organization_id}/projects/{location.project_id}/runtasks/{task_type}][%d] PackerService_GetRegistryTFCRunTaskAPI default %s", o._statusCode, payload)
}
