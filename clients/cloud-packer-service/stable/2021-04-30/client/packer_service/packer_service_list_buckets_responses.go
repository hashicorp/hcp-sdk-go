...
func (o *PackerServiceListBucketsOK) Error() string {
	...
	return fmt.Sprintf("[GET /packer/2021-04-30/organizations/{location.organization_id}/projects/{location.project_id}/images][%d] packerServiceListBucketsOK %s", 200, payload)
}
...
func (o *PackerServiceListBucketsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /packer/2021-04-30/organizations/{location.organization_id}/projects/{location.project_id}/images][%d] PackerService_ListBuckets default %s", o._statusCode, payload)
}
