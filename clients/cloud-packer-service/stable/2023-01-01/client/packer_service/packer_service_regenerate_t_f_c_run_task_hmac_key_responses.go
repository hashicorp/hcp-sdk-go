...
func (o *PackerServiceRegenerateTFCRunTaskHmacKeyOK) Error() string {
	return fmt.Sprintf("[PATCH /packer/2023-01-01/organizations/{location.organization_id}/projects/{location.project_id}/runtasks/hmac][%d] packerServiceRegenerateTFCRunTaskHmacKeyOK  %+v", 200, o.Payload)
}
...
func (o *PackerServiceRegenerateTFCRunTaskHmacKeyDefault) Error() string {
	return fmt.Sprintf("[PATCH /packer/2023-01-01/organizations/{location.organization_id}/projects/{location.project_id}/runtasks/hmac][%d] PackerService_RegenerateTFCRunTaskHmacKey default  %+v", o._statusCode, o.Payload)
}
