...
func (o *PackerServiceGetRegistryOK) Error() string {
	...
	return fmt.Sprintf("[GET /packer/2023-01-01/organizations/{location.organization_id}/projects/{location.project_id}/registry][%d] packerServiceGetRegistryOK %s", 200, payload)
}
...
func (o *PackerServiceGetRegistryDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /packer/2023-01-01/organizations/{location.organization_id}/projects/{location.project_id}/registry][%d] PackerService_GetRegistry default %s", o._statusCode, payload)
}
