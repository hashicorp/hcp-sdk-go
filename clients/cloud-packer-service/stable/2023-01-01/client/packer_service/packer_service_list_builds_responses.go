...
func (o *PackerServiceListBuildsOK) Error() string {
	return fmt.Sprintf("[GET /packer/2023-01-01/organizations/{location.organization_id}/projects/{location.project_id}/buckets/{bucket_name}/versions/{fingerprint}/builds][%d] packerServiceListBuildsOK  %+v", 200, o.Payload)
}
...
func (o *PackerServiceListBuildsDefault) Error() string {
	return fmt.Sprintf("[GET /packer/2023-01-01/organizations/{location.organization_id}/projects/{location.project_id}/buckets/{bucket_name}/versions/{fingerprint}/builds][%d] PackerService_ListBuilds default  %+v", o._statusCode, o.Payload)
}
