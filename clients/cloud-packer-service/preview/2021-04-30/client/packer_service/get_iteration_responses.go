...
func (o *GetIterationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewGetIterationDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
/*GetIterationOK handles this case with default header values.
...
// NewGetIterationDefault creates a GetIterationDefault with default headers values
func NewGetIterationDefault(code int) *GetIterationDefault {
	return &GetIterationDefault{
		_statusCode: code,
	}
}

/*GetIterationDefault handles this case with default header values.

An unexpected error response.
*/
type GetIterationDefault struct {
	_statusCode int

	Payload *cloud.GrpcGatewayRuntimeError
}

// Code gets the status code for the get iteration default response
func (o *GetIterationDefault) Code() int {
...
func (o *GetIterationDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
