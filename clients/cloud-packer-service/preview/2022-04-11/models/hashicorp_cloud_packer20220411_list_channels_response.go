...
func (m *HashicorpCloudPacker20220411ListChannelsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudPacker20220411ListChannelsResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HashicorpCloudPacker20220411ListChannelsResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudPacker20220411ListChannelsResponse
