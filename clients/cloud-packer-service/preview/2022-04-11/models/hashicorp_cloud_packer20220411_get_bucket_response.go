...
func (m *HashicorpCloudPacker20220411GetBucketResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudPacker20220411GetBucketResponse) validateBucket(formats strfmt.Registry) error {
...
func (m *HashicorpCloudPacker20220411GetBucketResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudPacker20220411GetBucketResponse) contextValidateBucket(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudPacker20220411GetBucketResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HashicorpCloudPacker20220411GetBucketResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudPacker20220411GetBucketResponse
