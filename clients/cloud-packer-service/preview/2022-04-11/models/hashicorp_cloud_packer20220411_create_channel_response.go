...
func (m *HashicorpCloudPacker20220411CreateChannelResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudPacker20220411CreateChannelResponse) contextValidateChannel(ctx context.Context, formats strfmt.Registry) error {
