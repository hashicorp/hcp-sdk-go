...
func (m *HashicorpCloudPacker20220411GetIterationResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudPacker20220411GetIterationResponse) contextValidateIteration(ctx context.Context, formats strfmt.Registry) error {
