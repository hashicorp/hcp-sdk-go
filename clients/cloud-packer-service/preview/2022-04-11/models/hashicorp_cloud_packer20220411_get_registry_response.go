...
func (m *HashicorpCloudPacker20220411GetRegistryResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudPacker20220411GetRegistryResponse) validateRegistry(formats strfmt.Registry) error {
...
func (m *HashicorpCloudPacker20220411GetRegistryResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudPacker20220411GetRegistryResponse) contextValidateRegistry(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudPacker20220411GetRegistryResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HashicorpCloudPacker20220411GetRegistryResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudPacker20220411GetRegistryResponse
