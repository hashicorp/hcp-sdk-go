...
func (m *HashicorpCloudPacker20220411CreateBucketResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudPacker20220411CreateBucketResponse) validateBucket(formats strfmt.Registry) error {
...
func (m *HashicorpCloudPacker20220411CreateBucketResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudPacker20220411CreateBucketResponse) contextValidateBucket(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudPacker20220411CreateBucketResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HashicorpCloudPacker20220411CreateBucketResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudPacker20220411CreateBucketResponse
