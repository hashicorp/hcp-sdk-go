...
func (m *HashicorpCloudPacker20220411CreateChannelRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudPacker20220411CreateChannelRequest) validateLocation(formats strfmt.Registry) error {
...
func (m *HashicorpCloudPacker20220411CreateChannelRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudPacker20220411CreateChannelRequest) contextValidateLocation(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudPacker20220411CreateChannelRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HashicorpCloudPacker20220411CreateChannelRequest) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudPacker20220411CreateChannelRequest
