...
func (m *HashicorpCloudPacker20220411GetBuildResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudPacker20220411GetBuildResponse) contextValidateBuild(ctx context.Context, formats strfmt.Registry) error {
