...
func (m *HashicorpCloudPacker20220411UpdateBuildResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudPacker20220411UpdateBuildResponse) validateBuild(formats strfmt.Registry) error {
...
func (m *HashicorpCloudPacker20220411UpdateBuildResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudPacker20220411UpdateBuildResponse) contextValidateBuild(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudPacker20220411UpdateBuildResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HashicorpCloudPacker20220411UpdateBuildResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudPacker20220411UpdateBuildResponse
