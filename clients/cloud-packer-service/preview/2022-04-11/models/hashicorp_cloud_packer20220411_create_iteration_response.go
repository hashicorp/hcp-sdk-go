...
func (m *HashicorpCloudPacker20220411CreateIterationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudPacker20220411CreateIterationResponse) validateIteration(formats strfmt.Registry) error {
...
func (m *HashicorpCloudPacker20220411CreateIterationResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudPacker20220411CreateIterationResponse) contextValidateIteration(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudPacker20220411CreateIterationResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HashicorpCloudPacker20220411CreateIterationResponse) UnmarshalBinary(b []byte) error {
	var res HashicorpCloudPacker20220411CreateIterationResponse
