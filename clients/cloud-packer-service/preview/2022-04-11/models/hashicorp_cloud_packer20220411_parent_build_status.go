...
// ContextValidate validate this hashicorp cloud packer 20220411 parent build status based on the context it is used
func (m *HashicorpCloudPacker20220411ParentBuildStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudPacker20220411ParentBuildStatus) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
