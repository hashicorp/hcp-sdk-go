...
// ContextValidate validate this hashicorp cloud vault 20200420 update public ips response based on the context it is used
func (m *HashicorpCloudVault20200420UpdatePublicIpsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudVault20200420UpdatePublicIpsResponse) contextValidateOperation(ctx context.Context, formats strfmt.Registry) error {
