...
// ContextValidate validate this hashicorp cloud vault 20200420 seal response based on the context it is used
func (m *HashicorpCloudVault20200420SealResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HashicorpCloudVault20200420SealResponse) contextValidateOperation(ctx context.Context, formats strfmt.Registry) error {
