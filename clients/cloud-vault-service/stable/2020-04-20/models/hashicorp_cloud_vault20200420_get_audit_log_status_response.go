...
// ContextValidate validate this hashicorp cloud vault 20200420 get audit log status response based on the context it is used
func (m *HashicorpCloudVault20200420GetAuditLogStatusResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
