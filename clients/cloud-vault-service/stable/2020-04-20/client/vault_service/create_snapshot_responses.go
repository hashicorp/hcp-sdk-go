...
func (o *CreateSnapshotOK) Error() string {
	...
	return fmt.Sprintf("[POST /vault/2020-04-20/organizations/{resource.location.organization_id}/projects/{resource.location.project_id}/snapshots][%d] createSnapshotOK %s", 200, payload)
}
...
func (o *CreateSnapshotDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /vault/2020-04-20/organizations/{resource.location.organization_id}/projects/{resource.location.project_id}/snapshots][%d] CreateSnapshot default %s", o._statusCode, payload)
}
