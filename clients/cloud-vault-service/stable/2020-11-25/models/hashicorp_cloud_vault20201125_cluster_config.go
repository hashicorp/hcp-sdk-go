...
type HashicorpCloudVault20201125ClusterConfig struct {
	...
	// disaster recovery network config
	...
	// reporting config
	ReportingConfig *HashicorpCloudVault20201125ReportingConfig `json:"reporting_config,omitempty"`
...
func (m *HashicorpCloudVault20201125ClusterConfig) validateDisasterRecoveryNetworkConfig(formats strfmt.Registry) error {
...
func (m *HashicorpCloudVault20201125ClusterConfig) validateReportingConfig(formats strfmt.Registry) error {
...
func (m *HashicorpCloudVault20201125ClusterConfig) contextValidateDisasterRecoveryNetworkConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HashicorpCloudVault20201125ClusterConfig) contextValidateReportingConfig(ctx context.Context, formats strfmt.Registry) error {
