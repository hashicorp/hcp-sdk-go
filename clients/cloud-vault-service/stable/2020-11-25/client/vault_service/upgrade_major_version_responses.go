...
func (o *UpgradeMajorVersionOK) Error() string {
	return fmt.Sprintf("[POST /vault/2020-11-25/organizations/{location.organization_id}/projects/{location.project_id}/clusters/{cluster_id}/upgrade-major-version][%d] upgradeMajorVersionOK  %+v", 200, o.Payload)
}
...
func (o *UpgradeMajorVersionDefault) Error() string {
	return fmt.Sprintf("[POST /vault/2020-11-25/organizations/{location.organization_id}/projects/{location.project_id}/clusters/{cluster_id}/upgrade-major-version][%d] UpgradeMajorVersion default  %+v", o._statusCode, o.Payload)
}
