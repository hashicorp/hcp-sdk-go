...
func (o *UpdateSnapshotOK) Error() string {
	...
	return fmt.Sprintf("[POST /vault/2020-11-25/organizations/{snapshot.location.organization_id}/projects/{snapshot.location.project_id}/snapshots/{snapshot.snapshot_id}][%d] updateSnapshotOK %s", 200, payload)
}
...
func (o *UpdateSnapshotDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /vault/2020-11-25/organizations/{snapshot.location.organization_id}/projects/{snapshot.location.project_id}/snapshots/{snapshot.snapshot_id}][%d] UpdateSnapshot default %s", o._statusCode, payload)
}
