...
type ActivationServiceActivateOK struct {
	Payload *models.HashicorpCloudInfragraph20250507ActivateResponse
}
...
func (o *ActivationServiceActivateOK) Error() string {
	...
	return fmt.Sprintf("[POST /infragraph/2025-05-07/organizations/{location.organization_id}/activate][%d] activationServiceActivateOK %s", 200, payload)
}
...
func (o *ActivationServiceActivateOK) GetPayload() *models.HashicorpCloudInfragraph20250507ActivateResponse {
	return o.Payload
}
...
func (o *ActivationServiceActivateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.HashicorpCloudInfragraph20250507ActivateResponse)
...
func (o *ActivationServiceActivateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /infragraph/2025-05-07/organizations/{location.organization_id}/activate][%d] ActivationService_Activate default %s", o._statusCode, payload)
}
...
func (o *ActivationServiceActivateDefault) GetPayload() *cloud.GoogleRPCStatus {
	return o.Payload
}
